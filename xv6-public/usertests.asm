...
00000670 <writetest1>:
{
  ...
  for(i = 0; i < MAXFILE; i++){
     ...
     6da:	81 fb 0c 01 00 00    	cmp    $0x10c,%ebx
  ...
  n = 0;
    ...
    if(i == 0){
     ...
     73f:	75 cf                	jne    710 <writetest1+0xa0>
      if(n == MAXFILE - 1){
     741:	81 fe 0b 01 00 00    	cmp    $0x10b,%esi
...
0000397b <numberofprocesses>:
SYSCALL(numberofprocesses)
    397b:	b8 18 00 00 00       	mov    $0x18,%eax
    3980:	cd 40                	int    $0x40
    3982:	c3                   	ret    
...
00003993 <va_to_pa>:
SYSCALL(va_to_pa)
    3993:	b8 1d 00 00 00       	mov    $0x1d,%eax
    3998:	cd 40                	int    $0x40
    399a:	c3                   	ret    

0000399b <get_pgtb_size>:
SYSCALL(get_pgtb_size)
    399b:	b8 1e 00 00 00       	mov    $0x1e,%eax
    39a0:	cd 40                	int    $0x40
    39a2:	c3                   	ret    

000039a3 <get_usr_pgtb_size>:
SYSCALL(get_usr_pgtb_size)
    39a3:	b8 1f 00 00 00       	mov    $0x1f,%eax
    39a8:	cd 40                	int    $0x40
    39aa:	c3                   	ret    

000039ab <get_kernel_pgtb_size>:
SYSCALL(get_kernel_pgtb_size)
    39ab:	b8 20 00 00 00       	mov    $0x20,%eax
    39b0:	cd 40                	int    $0x40
    39b2:	c3                   	ret    

000039b3 <getpasize>:
SYSCALL(getpasize)
    39b3:	b8 22 00 00 00       	mov    $0x22,%eax
    39b8:	cd 40                	int    $0x40
    39ba:	c3                   	ret    

000039bb <mmap>:
    39bb:	b8 23 00 00 00       	mov    $0x23,%eax
    39c0:	cd 40                	int    $0x40
    39c2:	c3                   	ret    
