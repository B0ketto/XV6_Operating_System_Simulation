...
_t_va_to_pa2:     file format elf32-i386
...
int main(int argc, char *argv[])
{
  ...
  int N = 10;
  12:	c7 45 f4 0a 00 00 00 	movl   $0xa,-0xc(%ebp)
  int va = (int)&N; // the virtual address of n
  int id = fork();
  19:	e8 bd 02 00 00       	call   2db <fork>
  if (id < 0)
  1e:	85 c0                	test   %eax,%eax
  20:	78 2e                	js     50 <main+0x50>
  int va = (int)&N; // the virtual address of n
  22:	8d 5d f4             	lea    -0xc(%ebp),%ebx
    exit();
  else if (id == 0)
  25:	75 2e                	jne    55 <main+0x55>
  {
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 c4 08 00 00 	movzbl 0x8c4(%edx),%edx
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 6c 08 00 00 	jmp    *0x86c(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 65 08 00 00       	mov    $0x865,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 70 0b 00 00       	mov    0xb70,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 70 0b 00 00    	mov    %edx,0xb70
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 70 0b 00 00    	mov    %edx,0xb70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 70 0b 00 00    	mov    0xb70,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 70 0b 00 00    	mov    0xb70,%edx
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 70 0b 00 00 74 	movl   $0xb74,0xb70
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 74 0b 00 00       	mov    $0xb74,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 74 0b 00 00 74 	movl   $0xb74,0xb74
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 78 0b 00 00 00 	movl   $0x0,0xb78
 7a2:	00 00 00 
    if(p->s.size >= nunits){
