...
_t_mmap:     file format elf32-i386
...
int main(int argc, char *argv[])
{
   ...
   f:	e8 4f 03 00 00       	call   363 <getpid>
  14:	83 ec 0c             	sub    $0xc,%esp
  17:	50                   	push   %eax
  18:	e8 7e 03 00 00       	call   39b <getvasize>
  1d:	83 c4 0c             	add    $0xc,%esp
  20:	50                   	push   %eax
  21:	68 b8 07 00 00       	push   $0x7b8
  26:	6a 01                	push   $0x1
  28:	e8 63 04 00 00       	call   490 <printf>
    char *addr = (char *)mmap(4096);
  2d:	c7 04 24 00 10 00 00 	movl   $0x1000,(%esp)
  34:	e8 92 03 00 00       	call   3cb <mmap>
  39:	89 c3                	mov    %eax,%ebx
    printf(1, "Process size after mmap %d Bytes\n", getvasize(getpid()));
  3b:	e8 23 03 00 00       	call   363 <getpid>
  40:	89 04 24             	mov    %eax,(%esp)
  43:	e8 53 03 00 00       	call   39b <getvasize>
  48:	83 c4 0c             	add    $0xc,%esp
  4b:	50                   	push   %eax
  4c:	68 dc 07 00 00       	push   $0x7dc
  51:	6a 01                	push   $0x1
  53:	e8 38 04 00 00       	call   490 <printf>
    printf(1, "Accessing a address allocated by mmap %p\n", (addr + 128));
  58:	83 c4 0c             	add    $0xc,%esp
  5b:	8d 83 80 00 00 00    	lea    0x80(%ebx),%eax
  61:	50                   	push   %eax
  62:	68 00 08 00 00       	push   $0x800
  67:	6a 01                	push   $0x1
  69:	e8 22 04 00 00       	call   490 <printf>
    printf(1,"%d", *(addr + 128));
  6e:	0f be 83 80 00 00 00 	movsbl 0x80(%ebx),%eax
  75:	83 c4 0c             	add    $0xc,%esp
  78:	50                   	push   %eax
  79:	68 2a 08 00 00       	push   $0x82a
  7e:	6a 01                	push   $0x1
  80:	e8 0b 04 00 00       	call   490 <printf>
    exit();
  85:	e8 59 02 00 00       	call   2e3 <exit>
  8a:	66 90                	xchg   %ax,%ax
  8c:	66 90                	xchg   %ax,%ax
  8e:	66 90                	xchg   %ax,%ax
 ...
 3ec:	89 d1                	mov    %edx,%ecx
{
 ...
 419:	0f b6 92 8c 08 00 00 	movzbl 0x88c(%edx),%edx
 ...
 499:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 509:	ff 24 85 34 08 00 00 	jmp    *0x834(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 617:	90                   	nop
          s = "(null)";
 618:	ba 2d 08 00 00       	mov    $0x82d,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 631:	a1 38 0b 00 00       	mov    0xb38,%eax
{
 ...
 671:	5b                   	pop    %ebx
  freep = p;
 672:	89 15 38 0b 00 00    	mov    %edx,0xb38
}
 678:	5e                   	pop    %esi
 679:	5f                   	pop    %edi
 67a:	5d                   	pop    %ebp
 ...
 6a9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6ac:	89 15 38 0b 00 00    	mov    %edx,0xb38
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6c9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6cc:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 70f:	73 4f                	jae    760 <malloc+0xa0>
    ...
    if(p == freep)
 711:	8b 3d 38 0b 00 00    	mov    0xb38,%edi
 ...
 73a:	e8 f1 fe ff ff       	call   630 <free>
  return freep;
 73f:	8b 15 38 0b 00 00    	mov    0xb38,%edx
 ...
 76c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 76f:	89 15 38 0b 00 00    	mov    %edx,0xb38
}
 ...
 77f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 780:	c7 05 38 0b 00 00 3c 	movl   $0xb3c,0xb38
 787:	0b 00 00 
    base.s.size = 0;
 78a:	bf 3c 0b 00 00       	mov    $0xb3c,%edi
    base.s.ptr = freep = prevp = &base;
 78f:	c7 05 3c 0b 00 00 3c 	movl   $0xb3c,0xb3c
 796:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 799:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 79b:	c7 05 40 0b 00 00 00 	movl   $0x0,0xb40
 7a2:	00 00 00 
    if(p->s.size >= nunits){
