...
8010005e:	b8 1c 28 11 80       	mov    $0x8011281c,%eax
  bcache.head.prev = &bcache.head;
80100063:	c7 05 6c 28 11 80 1c 	movl   $0x8011281c,0x8011286c
8010006a:	28 11 80 
  bcache.head.next = &bcache.head;
8010006d:	c7 05 70 28 11 80 1c 	movl   $0x8011281c,0x80112870
80100074:	28 11 80 
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
...
801000b0:	89 1d 70 28 11 80    	mov    %ebx,0x80112870
  for(b = bcache.buf; b < bcache.buf+NBUF; b++){
801000b6:	81 fb c0 23 11 80    	cmp    $0x801123c0,%ebx
...
801000e9:	8b 1d 70 28 11 80    	mov    0x80112870,%ebx
801000ef:	83 c4 10             	add    $0x10,%esp
801000f2:	81 fb 1c 28 11 80    	cmp    $0x8011281c,%ebx
801000f8:	75 11                	jne    8010010b <bread+0x3b>
801000fa:	eb 24                	jmp    80100120 <bread+0x50>
801000fc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80100100:	8b 5b 54             	mov    0x54(%ebx),%ebx
80100103:	81 fb 1c 28 11 80    	cmp    $0x8011281c,%ebx
...
80100120:	8b 1d 6c 28 11 80    	mov    0x8011286c,%ebx
80100126:	81 fb 1c 28 11 80    	cmp    $0x8011281c,%ebx
8010012c:	75 0d                	jne    8010013b <bread+0x6b>
8010012e:	eb 6e                	jmp    8010019e <bread+0xce>
80100130:	8b 5b 50             	mov    0x50(%ebx),%ebx
80100133:	81 fb 1c 28 11 80    	cmp    $0x8011281c,%ebx
...
8010023f:	89 50 54             	mov    %edx,0x54(%eax)
    b->next = bcache.head.next;
80100242:	a1 70 28 11 80       	mov    0x80112870,%eax
    b->prev = &bcache.head;
80100247:	c7 43 50 1c 28 11 80 	movl   $0x8011281c,0x50(%ebx)
    b->next = bcache.head.next;
8010024e:	89 43 54             	mov    %eax,0x54(%ebx)
    bcache.head.next->prev = b;
80100251:	a1 70 28 11 80       	mov    0x80112870,%eax
80100256:	89 58 50             	mov    %ebx,0x50(%eax)
    bcache.head.next = b;
80100259:	89 1d 70 28 11 80    	mov    %ebx,0x80112870
  }
...
80100294:	e8 c7 15 00 00       	call   80101860 <iunlock>
  acquire(&cons.lock);
80100299:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
...
801002b0:	a1 00 2d 11 80       	mov    0x80112d00,%eax
801002b5:	3b 05 04 2d 11 80    	cmp    0x80112d04,%eax
...
801002c3:	68 20 2d 11 80       	push   $0x80112d20
801002c8:	68 00 2d 11 80       	push   $0x80112d00
801002cd:	e8 6e 3d 00 00       	call   80104040 <sleep>
    while(input.r == input.w){
801002d2:	a1 00 2d 11 80       	mov    0x80112d00,%eax
801002d7:	83 c4 10             	add    $0x10,%esp
801002da:	3b 05 04 2d 11 80    	cmp    0x80112d04,%eax
...
801002f1:	68 20 2d 11 80       	push   $0x80112d20
...
8010031b:	89 15 00 2d 11 80    	mov    %edx,0x80112d00
80100321:	89 c2                	mov    %eax,%edx
80100323:	83 e2 7f             	and    $0x7f,%edx
80100326:	0f be 8a 80 2c 11 80 	movsbl -0x7feed380(%edx),%ecx
    if(c == C('D')){  // EOF
...
80100347:	68 20 2d 11 80       	push   $0x80112d20
...
8010036b:	73 d7                	jae    80100344 <consoleread+0xc4>
        input.r--;
8010036d:	a3 00 2d 11 80       	mov    %eax,0x80112d00
...
80100388:	fa                   	cli    
  cons.locking = 0;
80100389:	c7 05 54 2d 11 80 00 	movl   $0x0,0x80112d54
80100390:	00 00 00 
  getcallerpcs(&s, pcs);
...
801003e9:	c7 05 58 2d 11 80 01 	movl   $0x1,0x80112d58
801003f0:	00 00 00 
  for(;;)
...
8010059f:	e8 bc 12 00 00       	call   80101860 <iunlock>
  acquire(&cons.lock);
801005a4:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
...
801005ba:	8d 3c 33             	lea    (%ebx,%esi,1),%edi
  if(panicked){
801005bd:	8b 15 58 2d 11 80    	mov    0x80112d58,%edx
    consputc(buf[i] & 0xff);
...
801005df:	68 20 2d 11 80       	push   $0x80112d20
...
8010065f:	0f be c2             	movsbl %dl,%eax
  if(panicked){
80100662:	8b 15 58 2d 11 80    	mov    0x80112d58,%edx
...
801006a9:	a1 54 2d 11 80       	mov    0x80112d54,%eax
...
8010075a:	0f 84 08 01 00 00    	je     80100868 <cprintf+0x1c8>
  if(panicked){
80100760:	8b 15 58 2d 11 80    	mov    0x80112d58,%edx
...
801007a5:	8d 76 00             	lea    0x0(%esi),%esi
  if(panicked){
801007a8:	8b 0d 58 2d 11 80    	mov    0x80112d58,%ecx
...
801007b5:	8d 76 00             	lea    0x0(%esi),%esi
  if(panicked){
801007b8:	a1 58 2d 11 80       	mov    0x80112d58,%eax
...
801007e3:	68 20 2d 11 80       	push   $0x80112d20
801007e8:	e8 a3 3e 00 00       	call   80104690 <acquire>
801007ed:	83 c4 10             	add    $0x10,%esp
801007f0:	e9 c4 fe ff ff       	jmp    801006b9 <cprintf+0x19>
  if(panicked){
801007f5:	8b 0d 58 2d 11 80    	mov    0x80112d58,%ecx
801007fb:	85 c9                	test   %ecx,%ecx
801007fd:	75 31                	jne    80100830 <cprintf+0x190>
801007ff:	b8 25 00 00 00       	mov    $0x25,%eax
80100804:	89 55 e0             	mov    %edx,-0x20(%ebp)
80100807:	e8 f4 fb ff ff       	call   80100400 <consputc.part.0>
8010080c:	8b 15 58 2d 11 80    	mov    0x80112d58,%edx
...
80100856:	68 20 2d 11 80       	push   $0x80112d20
...
8010088b:	8b 7d 08             	mov    0x8(%ebp),%edi
  acquire(&cons.lock);
8010088e:	68 20 2d 11 80       	push   $0x80112d20
...
801008d3:	a1 08 2d 11 80       	mov    0x80112d08,%eax
801008d8:	89 c2                	mov    %eax,%edx
801008da:	2b 15 00 2d 11 80    	sub    0x80112d00,%edx
801008e0:	83 fa 7f             	cmp    $0x7f,%edx
801008e3:	77 d2                	ja     801008b7 <consoleintr+0x37>
        input.buf[input.e++ % INPUT_BUF] = c;
801008e5:	8d 48 01             	lea    0x1(%eax),%ecx
  if(panicked){
801008e8:	8b 15 58 2d 11 80    	mov    0x80112d58,%edx
        input.buf[input.e++ % INPUT_BUF] = c;
801008ee:	83 e0 7f             	and    $0x7f,%eax
801008f1:	89 0d 08 2d 11 80    	mov    %ecx,0x80112d08
        c = (c == '\r') ? '\n' : c;
801008f7:	83 fb 0d             	cmp    $0xd,%ebx
801008fa:	0f 84 13 01 00 00    	je     80100a13 <consoleintr+0x193>
        input.buf[input.e++ % INPUT_BUF] = c;
80100900:	88 98 80 2c 11 80    	mov    %bl,-0x7feed380(%eax)
  if(panicked){
...
80100927:	a1 00 2d 11 80       	mov    0x80112d00,%eax
8010092c:	83 e8 80             	sub    $0xffffff80,%eax
8010092f:	39 05 08 2d 11 80    	cmp    %eax,0x80112d08
80100935:	75 80                	jne    801008b7 <consoleintr+0x37>
80100937:	e9 fb 00 00 00       	jmp    80100a37 <consoleintr+0x1b7>
8010093c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
      while(input.e != input.w &&
80100940:	a1 08 2d 11 80       	mov    0x80112d08,%eax
80100945:	39 05 04 2d 11 80    	cmp    %eax,0x80112d04
...
80100956:	83 e2 7f             	and    $0x7f,%edx
      while(input.e != input.w &&
80100959:	80 ba 80 2c 11 80 0a 	cmpb   $0xa,-0x7feed380(%edx)
80100960:	0f 84 51 ff ff ff    	je     801008b7 <consoleintr+0x37>
  if(panicked){
80100966:	8b 15 58 2d 11 80    	mov    0x80112d58,%edx
        input.e--;
8010096c:	a3 08 2d 11 80       	mov    %eax,0x80112d08
  if(panicked){
...
8010097f:	90                   	nop
      if(input.e != input.w){
80100980:	a1 08 2d 11 80       	mov    0x80112d08,%eax
80100985:	3b 05 04 2d 11 80    	cmp    0x80112d04,%eax
8010098b:	0f 84 26 ff ff ff    	je     801008b7 <consoleintr+0x37>
        input.e--;
80100991:	83 e8 01             	sub    $0x1,%eax
80100994:	a3 08 2d 11 80       	mov    %eax,0x80112d08
  if(panicked){
80100999:	a1 58 2d 11 80       	mov    0x80112d58,%eax
...
801009ad:	e8 4e fa ff ff       	call   80100400 <consputc.part.0>
      while(input.e != input.w &&
801009b2:	a1 08 2d 11 80       	mov    0x80112d08,%eax
801009b7:	3b 05 04 2d 11 80    	cmp    0x80112d04,%eax
801009bd:	75 92                	jne    80100951 <consoleintr+0xd1>
801009bf:	e9 f3 fe ff ff       	jmp    801008b7 <consoleintr+0x37>
801009c4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  release(&cons.lock);
801009c8:	83 ec 0c             	sub    $0xc,%esp
801009cb:	68 20 2d 11 80       	push   $0x80112d20
...
80100a0e:	e9 cd 37 00 00       	jmp    801041e0 <procdump>
        input.buf[input.e++ % INPUT_BUF] = c;
80100a13:	c6 80 80 2c 11 80 0a 	movb   $0xa,-0x7feed380(%eax)
  if(panicked){
...
80100a2d:	e8 ce f9 ff ff       	call   80100400 <consputc.part.0>
          input.w = input.e;
80100a32:	a1 08 2d 11 80       	mov    0x80112d08,%eax
          wakeup(&input.r);
80100a37:	83 ec 0c             	sub    $0xc,%esp
          input.w = input.e;
80100a3a:	a3 04 2d 11 80       	mov    %eax,0x80112d04
          wakeup(&input.r);
80100a3f:	68 00 2d 11 80       	push   $0x80112d00
...
80100a6b:	68 20 2d 11 80       	push   $0x80112d20
...
80100a79:	6a 01                	push   $0x1
  devsw[CONSOLE].write = consolewrite;
80100a7b:	c7 05 0c 37 11 80 90 	movl   $0x80100590,0x8011370c
80100a82:	05 10 80 
  devsw[CONSOLE].read = consoleread;
80100a85:	c7 05 08 37 11 80 80 	movl   $0x80100280,0x80113708
80100a8c:	02 10 80 
  cons.locking = 1;
80100a8f:	c7 05 54 2d 11 80 01 	movl   $0x1,0x80112d54
80100a96:	00 00 00 
  ioapicenable(IRQ_KBD, 0);
...
80100e1b:	68 60 2d 11 80       	push   $0x80112d60
...
80100e34:	bb 94 2d 11 80       	mov    $0x80112d94,%ebx
{
80100e39:	83 ec 10             	sub    $0x10,%esp
  acquire(&ftable.lock);
80100e3c:	68 60 2d 11 80       	push   $0x80112d60
...
80100e53:	81 fb f4 36 11 80    	cmp    $0x801136f4,%ebx
...
80100e65:	c7 43 04 01 00 00 00 	movl   $0x1,0x4(%ebx)
      release(&ftable.lock);
80100e6c:	68 60 2d 11 80       	push   $0x80112d60
...
80100e83:	31 db                	xor    %ebx,%ebx
  release(&ftable.lock);
80100e85:	68 60 2d 11 80       	push   $0x80112d60
...
80100ea7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ftable.lock);
80100eaa:	68 60 2d 11 80       	push   $0x80112d60
...
80100ec4:	89 43 04             	mov    %eax,0x4(%ebx)
  release(&ftable.lock);
80100ec7:	68 60 2d 11 80       	push   $0x80112d60
...
80100ef9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ftable.lock);
80100efc:	68 60 2d 11 80       	push   $0x80112d60
...
80100f31:	8b 43 10             	mov    0x10(%ebx),%eax
  release(&ftable.lock);
80100f34:	68 60 2d 11 80       	push   $0x80112d60
  ff = *f;
...
80100f5d:	8d 76 00             	lea    0x0(%esi),%esi
    release(&ftable.lock);
80100f60:	c7 45 08 60 2d 11 80 	movl   $0x80112d60,0x8(%ebp)
}
...
801011c5:	c1 e8 0d             	shr    $0xd,%eax
801011c8:	03 05 cc 53 11 80    	add    0x801153cc,%eax
{
...
801011eb:	b8 01 00 00 00       	mov    $0x1,%eax
  if((bp->data[bi/8] & m) == 0)
801011f0:	81 e3 ff 03 00 00    	and    $0x3ff,%ebx
  m = 1 << (bi % 8);
...
80101249:	8b 0d b4 53 11 80    	mov    0x801153b4,%ecx
{
...
80101269:	c1 f8 0d             	sar    $0xd,%eax
8010126c:	03 05 cc 53 11 80    	add    0x801153cc,%eax
...
80101281:	a1 b4 53 11 80       	mov    0x801153b4,%eax
...
801012b5:	3d 00 20 00 00       	cmp    $0x2000,%eax
...
801012c7:	e8 24 ef ff ff       	call   801001f0 <brelse>
  for(b = 0; b < sb.size; b += BPB){
801012cc:	81 45 dc 00 20 00 00 	addl   $0x2000,-0x24(%ebp)
801012d3:	83 c4 10             	add    $0x10,%esp
801012d6:	8b 45 dc             	mov    -0x24(%ebp),%eax
801012d9:	39 05 b4 53 11 80    	cmp    %eax,0x801153b4
...
8010131d:	68 00 04 00 00       	push   $0x400
...
8010135a:	bb 94 37 11 80       	mov    $0x80113794,%ebx
{
8010135f:	83 ec 28             	sub    $0x28,%esp
80101362:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  acquire(&icache.lock);
80101365:	68 60 37 11 80       	push   $0x80113760
...
8010138a:	81 fb b4 53 11 80    	cmp    $0x801153b4,%ebx
...
801013a9:	81 fb b4 53 11 80    	cmp    $0x801153b4,%ebx
...
801013cb:	c7 46 4c 00 00 00 00 	movl   $0x0,0x4c(%esi)
  release(&icache.lock);
801013d2:	68 60 37 11 80       	push   $0x80113760
...
801013fb:	89 de                	mov    %ebx,%esi
      release(&icache.lock);
801013fd:	68 60 37 11 80       	push   $0x80113760
      ip->ref++;
...
8010141d:	81 fb b4 53 11 80    	cmp    $0x801153b4,%ebx
...
80101464:	8d 5a f4             	lea    -0xc(%edx),%ebx
  ...
  if(bn < NINDIRECT){
80101467:	81 fb ff 00 00 00    	cmp    $0xff,%ebx
8010146d:	0f 87 9f 00 00 00    	ja     80101512 <bmap+0xc2>
    // Load indirect block, allocating if necessary.
    if((addr = ip->addrs[NDIRECT]) == 0)
80101473:	8b 80 8c 00 00 00    	mov    0x8c(%eax),%eax
80101479:	85 c0                	test   %eax,%eax
8010147b:	74 5b                	je     801014d8 <bmap+0x88>
      ip->addrs[NDIRECT] = addr = balloc(ip->dev);
    bp = bread(ip->dev, addr);
8010147d:	83 ec 08             	sub    $0x8,%esp
80101480:	50                   	push   %eax
80101481:	ff 36                	push   (%esi)
80101483:	e8 48 ec ff ff       	call   801000d0 <bread>
    a = (uint*)bp->data;
    if((addr = a[bn]) == 0){
80101488:	83 c4 10             	add    $0x10,%esp
8010148b:	8d 5c 98 5c          	lea    0x5c(%eax,%ebx,4),%ebx
    bp = bread(ip->dev, addr);
8010148f:	89 c2                	mov    %eax,%edx
    if((addr = a[bn]) == 0){
80101491:	8b 3b                	mov    (%ebx),%edi
80101493:	85 ff                	test   %edi,%edi
80101495:	74 19                	je     801014b0 <bmap+0x60>
...
8010149b:	e8 50 ed ff ff       	call   801001f0 <brelse>
...
801014a3:	8d 65 f4             	lea    -0xc(%ebp),%esp
801014a6:	89 f8                	mov    %edi,%eax
801014a8:	5b                   	pop    %ebx
801014a9:	5e                   	pop    %esi
801014aa:	5f                   	pop    %edi
801014ab:	5d                   	pop    %ebp
...
801014d0:	eb c5                	jmp    80101497 <bmap+0x47>
801014d2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      ip->addrs[NDIRECT] = addr = balloc(ip->dev);
801014d8:	8b 06                	mov    (%esi),%eax
801014da:	e8 61 fd ff ff       	call   80101240 <balloc>
801014df:	89 86 8c 00 00 00    	mov    %eax,0x8c(%esi)
801014e5:	eb 96                	jmp    8010147d <bmap+0x2d>
...
801014f9:	75 a8                	jne    801014a3 <bmap+0x53>
      ip->addrs[bn] = addr = balloc(ip->dev);
...
80101564:	bb a0 37 11 80       	mov    $0x801137a0,%ebx
80101569:	83 ec 0c             	sub    $0xc,%esp
  initlock(&icache.lock, "icache");
8010156c:	68 eb 75 10 80       	push   $0x801075eb
80101571:	68 60 37 11 80       	push   $0x80113760
...
80101597:	81 fb c0 53 11 80    	cmp    $0x801153c0,%ebx
...
801015b7:	68 b4 53 11 80       	push   $0x801153b4
801015bc:	e8 2f 32 00 00       	call   801047f0 <memmove>
  brelse(bp);
801015c1:	89 1c 24             	mov    %ebx,(%esp)
801015c4:	e8 27 ec ff ff       	call   801001f0 <brelse>
  cprintf("sb: size %d nblocks %d ninodes %d nlog %d logstart %d\
801015c9:	ff 35 cc 53 11 80    	push   0x801153cc
801015cf:	ff 35 c8 53 11 80    	push   0x801153c8
801015d5:	ff 35 c4 53 11 80    	push   0x801153c4
801015db:	ff 35 c0 53 11 80    	push   0x801153c0
801015e1:	ff 35 bc 53 11 80    	push   0x801153bc
801015e7:	ff 35 b8 53 11 80    	push   0x801153b8
801015ed:	ff 35 b4 53 11 80    	push   0x801153b4
...
8010161c:	83 3d bc 53 11 80 01 	cmpl   $0x1,0x801153bc
{
...
8010164f:	3b 3d bc 53 11 80    	cmp    0x801153bc,%edi
80101655:	73 69                	jae    801016c0 <ialloc+0xb0>
    bp = bread(dev, IBLOCK(inum, sb));
80101657:	89 f8                	mov    %edi,%eax
80101659:	83 ec 08             	sub    $0x8,%esp
8010165c:	c1 e8 04             	shr    $0x4,%eax
8010165f:	03 05 c8 53 11 80    	add    0x801153c8,%eax
...
801016e1:	c1 e8 04             	shr    $0x4,%eax
801016e4:	03 05 c8 53 11 80    	add    0x801153c8,%eax
...
80101757:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&icache.lock);
8010175a:	68 60 37 11 80       	push   $0x80113760
8010175f:	e8 2c 2f 00 00       	call   80104690 <acquire>
  ip->ref++;
80101764:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101768:	c7 04 24 60 37 11 80 	movl   $0x80113760,(%esp)
...
801017c6:	c1 e8 04             	shr    $0x4,%eax
801017c9:	03 05 c8 53 11 80    	add    0x801153c8,%eax
...
801018da:	e8 51 2b 00 00       	call   80104430 <releasesleep>
  acquire(&icache.lock);
801018df:	c7 04 24 60 37 11 80 	movl   $0x80113760,(%esp)
801018e6:	e8 a5 2d 00 00       	call   80104690 <acquire>
  ip->ref--;
801018eb:	83 6b 08 01          	subl   $0x1,0x8(%ebx)
  release(&icache.lock);
801018ef:	83 c4 10             	add    $0x10,%esp
801018f2:	c7 45 08 60 37 11 80 	movl   $0x80113760,0x8(%ebp)
}
...
8010190b:	68 60 37 11 80       	push   $0x80113760
80101910:	e8 7b 2d 00 00       	call   80104690 <acquire>
    int r = ip->ref;
80101915:	8b 73 08             	mov    0x8(%ebx),%esi
    release(&icache.lock);
80101918:	c7 04 24 60 37 11 80 	movl   $0x80113760,(%esp)
...
801019ab:	8d 88 5c 04 00 00    	lea    0x45c(%eax),%ecx
...
80101b0d:	b9 00 04 00 00       	mov    $0x400,%ecx
    bp = bread(ip->dev, bmap(ip, off/BSIZE));
80101b12:	89 c2                	mov    %eax,%edx
    m = min(n - tot, BSIZE - off%BSIZE);
80101b14:	89 f0                	mov    %esi,%eax
80101b16:	25 ff 03 00 00       	and    $0x3ff,%eax
...
80101b6a:	8b 04 c5 00 37 11 80 	mov    -0x7feec900(,%eax,8),%eax
...
80101bd1:	3d 00 30 04 00       	cmp    $0x43000,%eax
...
80101c05:	e8 c6 e4 ff ff       	call   801000d0 <bread>
    m = min(n - tot, BSIZE - off%BSIZE);
80101c0a:	b9 00 04 00 00       	mov    $0x400,%ecx
...
80101c19:	25 ff 03 00 00       	and    $0x3ff,%eax
...
80101c7a:	8b 04 c5 04 37 11 80 	mov    -0x7feec8fc(,%eax,8),%eax
...
80101db2:	8b 70 68             	mov    0x68(%eax),%esi
  acquire(&icache.lock);
80101db5:	68 60 37 11 80       	push   $0x80113760
80101dba:	e8 d1 28 00 00       	call   80104690 <acquire>
  ip->ref++;
80101dbf:	83 46 08 01          	addl   $0x1,0x8(%esi)
  release(&icache.lock);
80101dc3:	c7 04 24 60 37 11 80 	movl   $0x80113760,(%esp)
...
80102088:	68 56 7c 10 80       	push   $0x80107c56
...
80102102:	01 f6                	add    %esi,%esi
  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80102104:	b9 f7 01 00 00       	mov    $0x1f7,%ecx
...
80102124:	b8 02 00 00 00       	mov    $0x2,%eax
...
80102180:	b9 00 01 00 00       	mov    $0x100,%ecx
    outsl(0x1f0, b->data, BSIZE/4);
...
801021cb:	68 00 54 11 80       	push   $0x80115400
801021d0:	e8 eb 22 00 00       	call   801044c0 <initlock>
  ioapicenable(IRQ_IDE, ncpu - 1);
801021d5:	58                   	pop    %eax
801021d6:	a1 84 55 11 80       	mov    0x80115584,%eax
801021db:	5a                   	pop    %edx
...
80102218:	74 f6                	je     80102210 <ideinit+0x50>
      havedisk1 = 1;
8010221a:	c7 05 e0 53 11 80 01 	movl   $0x1,0x801153e0
80102221:	00 00 00 
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
...
80102246:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&idelock);
80102249:	68 00 54 11 80       	push   $0x80115400
8010224e:	e8 3d 24 00 00       	call   80104690 <acquire>

  if((b = idequeue) == 0){
80102253:	8b 1d e4 53 11 80    	mov    0x801153e4,%ebx
...
80102263:	a3 e4 53 11 80       	mov    %eax,0x801153e4
...
80102292:	b9 00 01 00 00       	mov    $0x100,%ecx
...
801022ad:	e8 4e 1e 00 00       	call   80104100 <wakeup>
  ...
  if(idequeue != 0)
801022b2:	a1 e4 53 11 80       	mov    0x801153e4,%eax
...
801022c6:	68 00 54 11 80       	push   $0x80115400
...
80102313:	a1 e0 53 11 80       	mov    0x801153e0,%eax
...
80102323:	68 00 54 11 80       	push   $0x80115400
80102328:	e8 63 23 00 00       	call   80104690 <acquire>

  // Append b to idequeue.
  b->qnext = 0;
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
8010232d:	a1 e4 53 11 80       	mov    0x801153e4,%eax
  b->qnext = 0;
...
8010234c:	89 1a                	mov    %ebx,(%edx)
  ...
  if(idequeue == b)
8010234e:	39 1d e4 53 11 80    	cmp    %ebx,0x801153e4
...
80102363:	68 00 54 11 80       	push   $0x80115400
...
80102379:	75 e5                	jne    80102360 <iderw+0x80>
  ...
  release(&idelock);
8010237b:	c7 45 08 00 54 11 80 	movl   $0x80115400,0x8(%ebp)
}
...
80102399:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  for(pp=&idequeue; *pp; pp=&(*pp)->qnext)  //DOC:insert-queue
801023a0:	ba e4 53 11 80       	mov    $0x801153e4,%edx
...
801023d1:	c7 05 34 54 11 80 00 	movl   $0xfec00000,0x80115434
801023d8:	00 c0 fe 
{
...
801023e6:	00 00 00 
  return ioapic->data;
801023e9:	8b 15 34 54 11 80    	mov    0x80115434,%edx
801023ef:	8b 72 10             	mov    0x10(%edx),%esi
  ioapic->reg = reg;
801023f2:	c7 02 00 00 00 00    	movl   $0x0,(%edx)
  return ioapic->data;
801023f8:	8b 0d 34 54 11 80    	mov    0x80115434,%ecx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
  id = ioapicread(REG_ID) >> 24;
  if(id != ioapicid)
801023fe:	0f b6 15 80 55 11 80 	movzbl 0x80115580,%edx
  maxintr = (ioapicread(REG_VER) >> 16) & 0xFF;
...
8010241f:	e8 7c e2 ff ff       	call   801006a0 <cprintf>
  ioapic->reg = reg;
80102424:	8b 0d 34 54 11 80    	mov    0x80115434,%ecx
...
80102442:	89 c3                	mov    %eax,%ebx
  ioapic->data = data;
80102444:	8b 0d 34 54 11 80    	mov    0x80115434,%ecx
  for(i = 0; i <= maxintr; i++){
...
8010245c:	89 19                	mov    %ebx,(%ecx)
  ioapic->data = data;
8010245e:	8b 0d 34 54 11 80    	mov    0x80115434,%ecx
...
80102480:	55                   	push   %ebp
  ioapic->reg = reg;
80102481:	8b 0d 34 54 11 80    	mov    0x80115434,%ecx
{
...
80102493:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
80102495:	8b 0d 34 54 11 80    	mov    0x80115434,%ecx
...
801024a4:	89 01                	mov    %eax,(%ecx)
  ioapic->data = data;
801024a6:	a1 34 54 11 80       	mov    0x80115434,%eax
  ioapicwrite(REG_TABLE+2*irq+1, cpunum << 24);
...
801024d2:	81 fb d0 92 11 80    	cmp    $0x801192d0,%ebx
...
801024f2:	e8 59 22 00 00       	call   80104750 <memset>
  ...
  if(kmem.use_lock)
801024f7:	8b 15 74 54 11 80    	mov    0x80115474,%edx
...
80102504:	a1 78 54 11 80       	mov    0x80115478,%eax
80102509:	89 03                	mov    %eax,(%ebx)
  kmem.freelist = r;
  if(kmem.use_lock)
8010250b:	a1 74 54 11 80       	mov    0x80115474,%eax
  kmem.freelist = r;
80102510:	89 1d 78 54 11 80    	mov    %ebx,0x80115478
  if(kmem.use_lock)
...
80102523:	68 40 54 11 80       	push   $0x80115440
80102528:	e8 63 21 00 00       	call   80104690 <acquire>
8010252d:	83 c4 10             	add    $0x10,%esp
80102530:	eb d2                	jmp    80102504 <kfree+0x44>
80102532:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    release(&kmem.lock);
80102538:	c7 45 08 40 54 11 80 	movl   $0x80115440,0x8(%ebp)
}
...
801025f2:	73 e4                	jae    801025d8 <kinit2+0x28>
  kmem.use_lock = 1;
801025f4:	c7 05 74 54 11 80 01 	movl   $0x1,0x80115474
801025fb:	00 00 00 
}
...
80102620:	68 40 54 11 80       	push   $0x80115440
...
8010262d:	83 c4 10             	add    $0x10,%esp
  kmem.use_lock = 0;
80102630:	c7 05 74 54 11 80 00 	movl   $0x0,0x80115474
80102637:	00 00 00 
  p = (char*)PGROUNDUP((uint)vstart);
...
kalloc(void)
{
  ...
  if(kmem.use_lock)
80102680:	a1 74 54 11 80       	mov    0x80115474,%eax
80102685:	85 c0                	test   %eax,%eax
80102687:	75 1f                	jne    801026a8 <kalloc+0x28>
    acquire(&kmem.lock);
  r = kmem.freelist;
80102689:	a1 78 54 11 80       	mov    0x80115478,%eax
  if(r)
8010268e:	85 c0                	test   %eax,%eax
80102690:	74 0e                	je     801026a0 <kalloc+0x20>
    kmem.freelist = r->next;
80102692:	8b 10                	mov    (%eax),%edx
80102694:	89 15 78 54 11 80    	mov    %edx,0x80115478
  if(kmem.use_lock)
8010269a:	c3                   	ret    
...
801026ab:	83 ec 24             	sub    $0x24,%esp
    acquire(&kmem.lock);
801026ae:	68 40 54 11 80       	push   $0x80115440
801026b3:	e8 d8 1f 00 00       	call   80104690 <acquire>
  r = kmem.freelist;
801026b8:	a1 78 54 11 80       	mov    0x80115478,%eax
  if(kmem.use_lock)
801026bd:	8b 15 74 54 11 80    	mov    0x80115474,%edx
  if(r)
...
801026cc:	89 0d 78 54 11 80    	mov    %ecx,0x80115478
  if(kmem.use_lock)
...
801026dc:	68 40 54 11 80       	push   $0x80115440
...
80102707:	ec                   	in     (%dx),%al
  ...
  if(data == 0xE0){
    shift |= E0ESC;
80102708:	8b 1d 7c 54 11 80    	mov    0x8011547c,%ebx
  data = inb(KBDATAP);
...
8010273d:	89 d0                	mov    %edx,%eax
  shift ^= togglecode[data];
8010273f:	89 15 7c 54 11 80    	mov    %edx,0x8011547c
  c = charcode[shift & (CTL | SHIFT)][data];
...
80102773:	31 c0                	xor    %eax,%eax
    shift |= E0ESC;
80102775:	89 1d 7c 54 11 80    	mov    %ebx,0x8011547c
}
...
80102799:	8b 5d fc             	mov    -0x4(%ebp),%ebx
    shift &= ~(shiftcode[data] | E0ESC);
8010279c:	a3 7c 54 11 80       	mov    %eax,0x8011547c
    return 0;
...
{
  if(!lapic)
801027f0:	a1 80 54 11 80       	mov    0x80115480,%eax
...
{
  if (!lapic)
801028f0:	a1 80 54 11 80       	mov    0x80115480,%eax
...
{
  if(lapic)
80102910:	a1 80 54 11 80       	mov    0x80115480,%eax
...
80102978:	66 a3 69 04 00 80    	mov    %ax,0x80000469
  lapic[index] = value;
8010297e:	a1 80 54 11 80       	mov    0x80115480,%eax
...
80102bc0:	8b 0d e8 54 11 80    	mov    0x801154e8,%ecx
...
80102be0:	a1 d4 54 11 80       	mov    0x801154d4,%eax
80102be5:	83 ec 08             	sub    $0x8,%esp
80102be8:	01 f8                	add    %edi,%eax
80102bea:	83 c0 01             	add    $0x1,%eax
80102bed:	50                   	push   %eax
80102bee:	ff 35 e4 54 11 80    	push   0x801154e4
80102bf4:	e8 d7 d4 ff ff       	call   801000d0 <bread>
80102bf9:	89 c6                	mov    %eax,%esi
    struct buf *dbuf = bread(log.dev, log.lh.block[tail]); // read dst
80102bfb:	58                   	pop    %eax
80102bfc:	5a                   	pop    %edx
80102bfd:	ff 34 bd ec 54 11 80 	push   -0x7feeab14(,%edi,4)
80102c04:	ff 35 e4 54 11 80    	push   0x801154e4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102c1a:	68 00 04 00 00       	push   $0x400
...
80102c44:	39 3d e8 54 11 80    	cmp    %edi,0x801154e8
...
80102c67:	ff 35 d4 54 11 80    	push   0x801154d4
80102c6d:	ff 35 e4 54 11 80    	push   0x801154e4
...
80102c7b:	89 c3                	mov    %eax,%ebx
  hb->n = log.lh.n;
80102c7d:	a1 e8 54 11 80       	mov    0x801154e8,%eax
...
80102c90:	8b 0c 95 ec 54 11 80 	mov    -0x7feeab14(,%edx,4),%ecx
...
80102ccf:	68 a0 54 11 80       	push   $0x801154a0
...
80102ce8:	59                   	pop    %ecx
  log.dev = dev;
80102ce9:	89 1d e4 54 11 80    	mov    %ebx,0x801154e4
  log.size = sb.nlog;
80102cef:	8b 55 e8             	mov    -0x18(%ebp),%edx
  log.start = sb.logstart;
80102cf2:	a3 d4 54 11 80       	mov    %eax,0x801154d4
  log.size = sb.nlog;
80102cf7:	89 15 d8 54 11 80    	mov    %edx,0x801154d8
  struct buf *buf = bread(log.dev, log.start);
80102cfd:	5a                   	pop    %edx
...
80102d0b:	89 1d e8 54 11 80    	mov    %ebx,0x801154e8
  for (i = 0; i < log.lh.n; i++) {
...
80102d24:	89 0c 95 ec 54 11 80 	mov    %ecx,-0x7feeab14(,%edx,4)
  for (i = 0; i < log.lh.n; i++) {
...
80102d3b:	e8 80 fe ff ff       	call   80102bc0 <install_trans>
  log.lh.n = 0;
80102d40:	c7 05 e8 54 11 80 00 	movl   $0x0,0x801154e8
80102d47:	00 00 00 
...
80102d63:	83 ec 14             	sub    $0x14,%esp
  acquire(&log.lock);
80102d66:	68 a0 54 11 80       	push   $0x801154a0
...
80102d7b:	68 a0 54 11 80       	push   $0x801154a0
80102d80:	68 a0 54 11 80       	push   $0x801154a0
80102d85:	e8 b6 12 00 00       	call   80104040 <sleep>
80102d8a:	83 c4 10             	add    $0x10,%esp
    if(log.committing){
80102d8d:	a1 e0 54 11 80       	mov    0x801154e0,%eax
80102d92:	85 c0                	test   %eax,%eax
80102d94:	75 e2                	jne    80102d78 <begin_op+0x18>
    } else if(log.lh.n + (log.outstanding+1)*MAXOPBLOCKS > LOGSIZE){
80102d96:	a1 dc 54 11 80       	mov    0x801154dc,%eax
80102d9b:	8b 15 e8 54 11 80    	mov    0x801154e8,%edx
...
80102daf:	83 ec 0c             	sub    $0xc,%esp
      log.outstanding += 1;
80102db2:	a3 dc 54 11 80       	mov    %eax,0x801154dc
      release(&log.lock);
80102db7:	68 a0 54 11 80       	push   $0x801154a0
...
80102dd6:	83 ec 18             	sub    $0x18,%esp
  ...
  acquire(&log.lock);
80102dd9:	68 a0 54 11 80       	push   $0x801154a0
80102dde:	e8 ad 18 00 00       	call   80104690 <acquire>
  log.outstanding -= 1;
80102de3:	a1 dc 54 11 80       	mov    0x801154dc,%eax
  if(log.committing)
80102de8:	8b 35 e0 54 11 80    	mov    0x801154e0,%esi
80102dee:	83 c4 10             	add    $0x10,%esp
  log.outstanding -= 1;
80102df1:	8d 58 ff             	lea    -0x1(%eax),%ebx
80102df4:	89 1d dc 54 11 80    	mov    %ebx,0x801154dc
  if(log.committing)
...
80102e04:	0f 85 f6 00 00 00    	jne    80102f00 <end_op+0x130>
    do_commit = 1;
    log.committing = 1;
80102e0a:	c7 05 e0 54 11 80 01 	movl   $0x1,0x801154e0
80102e11:	00 00 00 
...
80102e17:	68 a0 54 11 80       	push   $0x801154a0
...
{
  if (log.lh.n > 0) {
80102e21:	8b 0d e8 54 11 80    	mov    0x801154e8,%ecx
80102e27:	83 c4 10             	add    $0x10,%esp
80102e2a:	85 c9                	test   %ecx,%ecx
80102e2c:	7f 42                	jg     80102e70 <end_op+0xa0>
    acquire(&log.lock);
80102e2e:	83 ec 0c             	sub    $0xc,%esp
80102e31:	68 a0 54 11 80       	push   $0x801154a0
80102e36:	e8 55 18 00 00       	call   80104690 <acquire>
    wakeup(&log);
80102e3b:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
    log.committing = 0;
80102e42:	c7 05 e0 54 11 80 00 	movl   $0x0,0x801154e0
80102e49:	00 00 00 
    wakeup(&log);
80102e4c:	e8 af 12 00 00       	call   80104100 <wakeup>
    release(&log.lock);
80102e51:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
...
80102e70:	a1 d4 54 11 80       	mov    0x801154d4,%eax
80102e75:	83 ec 08             	sub    $0x8,%esp
80102e78:	01 d8                	add    %ebx,%eax
80102e7a:	83 c0 01             	add    $0x1,%eax
80102e7d:	50                   	push   %eax
80102e7e:	ff 35 e4 54 11 80    	push   0x801154e4
80102e84:	e8 47 d2 ff ff       	call   801000d0 <bread>
80102e89:	89 c6                	mov    %eax,%esi
    struct buf *from = bread(log.dev, log.lh.block[tail]); // cache block
80102e8b:	58                   	pop    %eax
80102e8c:	5a                   	pop    %edx
80102e8d:	ff 34 9d ec 54 11 80 	push   -0x7feeab14(,%ebx,4)
80102e94:	ff 35 e4 54 11 80    	push   0x801154e4
  for (tail = 0; tail < log.lh.n; tail++) {
...
80102eaa:	68 00 04 00 00       	push   $0x400
...
80102ed4:	3b 1d e8 54 11 80    	cmp    0x801154e8,%ebx
...
80102ee1:	e8 da fc ff ff       	call   80102bc0 <install_trans>
    log.lh.n = 0;
80102ee6:	c7 05 e8 54 11 80 00 	movl   $0x0,0x801154e8
80102eed:	00 00 00 
...
80102f03:	68 a0 54 11 80       	push   $0x801154a0
80102f08:	e8 f3 11 00 00       	call   80104100 <wakeup>
  release(&log.lock);
80102f0d:	c7 04 24 a0 54 11 80 	movl   $0x801154a0,(%esp)
...
80102f47:	8b 15 e8 54 11 80    	mov    0x801154e8,%edx
{
80102f4d:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if (log.lh.n >= LOGSIZE || log.lh.n >= log.size - 1)
80102f50:	83 fa 1d             	cmp    $0x1d,%edx
80102f53:	0f 8f 85 00 00 00    	jg     80102fde <log_write+0x9e>
80102f59:	a1 d8 54 11 80       	mov    0x801154d8,%eax
80102f5e:	83 e8 01             	sub    $0x1,%eax
80102f61:	39 c2                	cmp    %eax,%edx
80102f63:	7d 79                	jge    80102fde <log_write+0x9e>
    panic("too big a transaction");
  if (log.outstanding < 1)
80102f65:	a1 dc 54 11 80       	mov    0x801154dc,%eax
...
80102f71:	68 a0 54 11 80       	push   $0x801154a0
80102f76:	e8 15 17 00 00       	call   80104690 <acquire>
  for (i = 0; i < log.lh.n; i++) {
80102f7b:	8b 15 e8 54 11 80    	mov    0x801154e8,%edx
...
80102f95:	74 29                	je     80102fc0 <log_write+0x80>
    if (log.lh.block[i] == b->blockno)   // log absorbtion
80102f97:	39 0c 85 ec 54 11 80 	cmp    %ecx,-0x7feeab14(,%eax,4)
80102f9e:	75 f0                	jne    80102f90 <log_write+0x50>
      break;
  }
  log.lh.block[i] = b->blockno;
80102fa0:	89 0c 85 ec 54 11 80 	mov    %ecx,-0x7feeab14(,%eax,4)
  if (i == log.lh.n)
    log.lh.n++;
...
80102faa:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  release(&log.lock);
80102fad:	c7 45 08 a0 54 11 80 	movl   $0x801154a0,0x8(%ebp)
}
80102fb4:	c9                   	leave  
  release(&log.lock);
...
80102fba:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  log.lh.block[i] = b->blockno;
80102fc0:	89 0c 95 ec 54 11 80 	mov    %ecx,-0x7feeab14(,%edx,4)
    log.lh.n++;
80102fc7:	83 c2 01             	add    $0x1,%edx
80102fca:	89 15 e8 54 11 80    	mov    %edx,0x801154e8
80102fd0:	eb d5                	jmp    80102fa7 <log_write+0x67>
  log.lh.block[i] = b->blockno;
80102fd2:	8b 43 08             	mov    0x8(%ebx),%eax
80102fd5:	a3 ec 54 11 80       	mov    %eax,0x801154ec
  if (i == log.lh.n)
...
80103077:	68 d0 92 11 80       	push   $0x801192d0
...
801030dc:	69 05 84 55 11 80 b0 	imul   $0xb0,0x80115584,%eax
801030e3:	00 00 00 
801030e6:	05 a0 55 11 80       	add    $0x801155a0,%eax
801030eb:	3d a0 55 11 80       	cmp    $0x801155a0,%eax
801030f0:	76 7e                	jbe    80103170 <main+0x110>
801030f2:	bb a0 55 11 80       	mov    $0x801155a0,%ebx
801030f7:	eb 20                	jmp    80103119 <main+0xb9>
801030f9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80103100:	69 05 84 55 11 80 b0 	imul   $0xb0,0x80115584,%eax
80103107:	00 00 00 
8010310a:	81 c3 b0 00 00 00    	add    $0xb0,%ebx
80103110:	05 a0 55 11 80       	add    $0x801155a0,%eax
...
801032d6:	a3 80 54 11 80       	mov    %eax,0x80115480
...
80103354:	83 c0 08             	add    $0x8,%eax
      ioapicid = ioapic->apicno;
80103357:	88 0d 80 55 11 80    	mov    %cl,0x80115580
      continue;
8010335d:	eb 99                	jmp    801032f8 <mpinit+0xe8>
8010335f:	90                   	nop
      if(ncpu < NCPU) {
80103360:	8b 0d 84 55 11 80    	mov    0x80115584,%ecx
...
80103378:	89 0d 84 55 11 80    	mov    %ecx,0x80115584
        cpus[ncpu].apicid = proc->apicid;  // apicid may differ from ncpu
8010337e:	88 9f a0 55 11 80    	mov    %bl,-0x7feeaa60(%edi)
...
801037b4:	bb 54 5b 11 80       	mov    $0x80115b54,%ebx
{
801037b9:	83 ec 10             	sub    $0x10,%esp
  acquire(&ptable.lock);
801037bc:	68 20 5b 11 80       	push   $0x80115b20
...
801037d3:	81 fb 54 7a 11 80    	cmp    $0x80117a54,%ebx
...
801037f4:	8d 50 01             	lea    0x1(%eax),%edx
  release(&ptable.lock);
801037f7:	68 20 5b 11 80       	push   $0x80115b20
  p->pid = nextpid++;
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 9b 5b 10 80 	movl   $0x80105b9b,0x14(%eax)
  p->context = (struct context*)sp;
...
80103853:	31 db                	xor    %ebx,%ebx
  release(&ptable.lock);
80103855:	68 20 5b 11 80       	push   $0x80115b20
...
80103883:	83 ec 14             	sub    $0x14,%esp
  ...
  release(&ptable.lock);
80103886:	68 20 5b 11 80       	push   $0x80115b20
...
801038db:	68 20 5b 11 80       	push   $0x80115b20
801038e0:	e8 db 0b 00 00       	call   801044c0 <initlock>
}
...
801038fc:	e8 ef ef ff ff       	call   801028f0 <lapicid>
  for (i = 0; i < ncpu; ++i) {
80103901:	8b 35 84 55 11 80    	mov    0x80115584,%esi
...
8010391d:	0f b6 99 a0 55 11 80 	movzbl -0x7feeaa60(%ecx),%ebx
80103924:	39 c3                	cmp    %eax,%ebx
80103926:	75 e8                	jne    80103910 <mycpu+0x20>
}
80103928:	8d 65 f8             	lea    -0x8(%ebp),%esp
      return &cpus[i];
8010392b:	8d 81 a0 55 11 80    	lea    -0x7feeaa60(%ecx),%eax
}
80103931:	5b                   	pop    %ebx
80103932:	5e                   	pop    %esi
80103933:	5d                   	pop    %ebp
...
8010395b:	c9                   	leave  
  return mycpu()-cpus;
8010395c:	2d a0 55 11 80       	sub    $0x801155a0,%eax
...
801039ac:	89 c3                	mov    %eax,%ebx
  initproc = p;
801039ae:	a3 54 7a 11 80       	mov    %eax,0x80117a54
...
801039e6:	e8 65 0d 00 00       	call   80104750 <memset>
...
80103a45:	e8 c6 0e 00 00       	call   80104910 <safestrcpy>
  p->cwd = namei("/");
...
80103a56:	89 43 68             	mov    %eax,0x68(%ebx)
  acquire(&ptable.lock);
80103a59:	c7 04 24 20 5b 11 80 	movl   $0x80115b20,(%esp)
80103a60:	e8 2b 0c 00 00       	call   80104690 <acquire>
  p->state = RUNNABLE;
80103a65:	c7 43 0c 03 00 00 00 	movl   $0x3,0xc(%ebx)
  release(&ptable.lock);
80103a6c:	c7 04 24 20 5b 11 80 	movl   $0x80115b20,(%esp)
80103a73:	e8 b8 0b 00 00       	call   80104630 <release>
}
...
80103bc1:	e8 4a 0d 00 00       	call   80104910 <safestrcpy>
  pid = np->pid;
80103bc6:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103bc9:	c7 04 24 20 5b 11 80 	movl   $0x80115b20,(%esp)
80103bd0:	e8 bb 0a 00 00       	call   80104690 <acquire>
  np->state = RUNNABLE;
80103bd5:	c7 47 0c 03 00 00 00 	movl   $0x3,0xc(%edi)
  release(&ptable.lock);
80103bdc:	c7 04 24 20 5b 11 80 	movl   $0x80115b20,(%esp)
...
80103c51:	83 ec 0c             	sub    $0xc,%esp
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c54:	bb 54 5b 11 80       	mov    $0x80115b54,%ebx
    acquire(&ptable.lock);
80103c59:	68 20 5b 11 80       	push   $0x80115b20
...
80103c80:	e8 ab 30 00 00       	call   80106d30 <switchuvm>
...
80103c8b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103c92:	e8 d4 0c 00 00       	call   8010496b <swtch>
      switchkvm();
80103c97:	e8 84 30 00 00       	call   80106d20 <switchkvm>
      c->proc = 0;
...
80103cac:	81 fb 54 7a 11 80    	cmp    $0x80117a54,%ebx
80103cb2:	75 bc                	jne    80103c70 <scheduler+0x40>
    release(&ptable.lock);
80103cb4:	83 ec 0c             	sub    $0xc,%esp
80103cb7:	68 20 5b 11 80       	push   $0x80115b20
80103cbc:	e8 6f 09 00 00       	call   80104630 <release>
    sti();
...
80103cd4:	53                   	push   %ebx
  pushcli();
80103cd5:	e8 66 08 00 00       	call   80104540 <pushcli>
  c = mycpu();
80103cda:	e8 11 fc ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103cdf:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103ce5:	e8 a6 08 00 00       	call   80104590 <popcli>
  if(!holding(&ptable.lock))
80103cea:	83 ec 0c             	sub    $0xc,%esp
80103ced:	68 20 5b 11 80       	push   $0x80115b20
80103cf2:	e8 f9 08 00 00       	call   801045f0 <holding>
...
80103d33:	e8 33 0c 00 00       	call   8010496b <swtch>
  mycpu()->intena = intena;
...
80103d99:	e8 d2 fb ff ff       	call   80103970 <myproc>
  if(curproc == initproc)
80103d9e:	39 05 54 7a 11 80    	cmp    %eax,0x80117a54
...
80103dec:	c7 43 68 00 00 00 00 	movl   $0x0,0x68(%ebx)
  acquire(&ptable.lock);
80103df3:	c7 04 24 20 5b 11 80 	movl   $0x80115b20,(%esp)
80103dfa:	e8 91 08 00 00       	call   80104690 <acquire>
...
80103e2f:	3d 54 7a 11 80       	cmp    $0x80117a54,%eax
80103e34:	75 e4                	jne    80103e1a <exit+0x8a>
      p->parent = initproc;
80103e36:	8b 0d 54 7a 11 80    	mov    0x80117a54,%ecx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103e3c:	ba 54 5b 11 80       	mov    $0x80115b54,%edx
80103e41:	eb 10                	jmp    80103e53 <exit+0xc3>
80103e43:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80103e47:	90                   	nop
80103e48:	83 c2 7c             	add    $0x7c,%edx
80103e4b:	81 fa 54 7a 11 80    	cmp    $0x80117a54,%edx
...
80103f11:	b8 01 00 00 00       	mov    $0x1,%eax
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103f16:	81 fb 54 7a 11 80    	cmp    $0x80117a54,%ebx
...
80103f2b:	0f 85 95 00 00 00    	jne    80103fc6 <wait+0x106>
  pushcli();
80103f31:	e8 0a 06 00 00       	call   80104540 <pushcli>
  c = mycpu();
80103f36:	e8 b5 f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103f3b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f41:	e8 4a 06 00 00       	call   80104590 <popcli>
  if(p == 0)
...
80103f89:	e8 82 31 00 00       	call   80107110 <freevm>
        p->pid = 0;
...
80103fa7:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fae:	c7 04 24 20 5b 11 80 	movl   $0x80115b20,(%esp)
80103fb5:	e8 76 06 00 00       	call   80104630 <release>
        return pid;
...
80103fc9:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80103fce:	68 20 5b 11 80       	push   $0x80115b20
80103fd3:	e8 58 06 00 00       	call   80104630 <release>
      return -1;
...
80103ff7:	68 20 5b 11 80       	push   $0x80115b20
80103ffc:	e8 8f 06 00 00       	call   80104690 <acquire>
  pushcli();
...
8010401d:	e8 ae fc ff ff       	call   80103cd0 <sched>
  release(&ptable.lock);
80104022:	c7 04 24 20 5b 11 80 	movl   $0x80115b20,(%esp)
80104029:	e8 02 06 00 00       	call   80104630 <release>
}
...
8010404c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010404f:	e8 ec 04 00 00       	call   80104540 <pushcli>
  c = mycpu();
80104054:	e8 97 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104059:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010405f:	e8 2c 05 00 00       	call   80104590 <popcli>
  if(p == 0)
...
80104070:	81 fe 20 5b 11 80    	cmp    $0x80115b20,%esi
80104076:	74 50                	je     801040c8 <sleep+0x88>
    acquire(&ptable.lock);  //DOC: sleeplock1
80104078:	83 ec 0c             	sub    $0xc,%esp
8010407b:	68 20 5b 11 80       	push   $0x80115b20
80104080:	e8 0b 06 00 00       	call   80104690 <acquire>
    release(lk);
80104085:	89 34 24             	mov    %esi,(%esp)
80104088:	e8 a3 05 00 00       	call   80104630 <release>
  p->chan = chan;
...
8010409c:	c7 43 20 00 00 00 00 	movl   $0x0,0x20(%ebx)
    release(&ptable.lock);
801040a3:	c7 04 24 20 5b 11 80 	movl   $0x80115b20,(%esp)
801040aa:	e8 81 05 00 00       	call   80104630 <release>
    acquire(lk);
...
801040bb:	5d                   	pop    %ebp
    acquire(lk);
801040bc:	e9 cf 05 00 00       	jmp    80104690 <acquire>
...
80104107:	8b 5d 08             	mov    0x8(%ebp),%ebx
  acquire(&ptable.lock);
8010410a:	68 20 5b 11 80       	push   $0x80115b20
8010410f:	e8 7c 05 00 00       	call   80104690 <acquire>
80104114:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104117:	b8 54 5b 11 80       	mov    $0x80115b54,%eax
8010411c:	eb 0c                	jmp    8010412a <wakeup+0x2a>
8010411e:	66 90                	xchg   %ax,%ax
80104120:	83 c0 7c             	add    $0x7c,%eax
80104123:	3d 54 7a 11 80       	cmp    $0x80117a54,%eax
...
8010413f:	3d 54 7a 11 80       	cmp    $0x80117a54,%eax
80104144:	75 e4                	jne    8010412a <wakeup+0x2a>
  wakeup1(chan);
  release(&ptable.lock);
80104146:	c7 45 08 20 5b 11 80 	movl   $0x80115b20,0x8(%ebp)
}
8010414d:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80104150:	c9                   	leave  
  release(&ptable.lock);
80104151:	e9 da 04 00 00       	jmp    80104630 <release>
...
80104167:	8b 5d 08             	mov    0x8(%ebp),%ebx
  ...
  acquire(&ptable.lock);
8010416a:	68 20 5b 11 80       	push   $0x80115b20
8010416f:	e8 1c 05 00 00       	call   80104690 <acquire>
80104174:	83 c4 10             	add    $0x10,%esp
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104177:	b8 54 5b 11 80       	mov    $0x80115b54,%eax
8010417c:	eb 0c                	jmp    8010418a <kill+0x2a>
8010417e:	66 90                	xchg   %ax,%ax
80104180:	83 c0 7c             	add    $0x7c,%eax
80104183:	3d 54 7a 11 80       	cmp    $0x80117a54,%eax
...
801041a6:	68 20 5b 11 80       	push   $0x80115b20
801041ab:	e8 80 04 00 00       	call   80104630 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
801041c3:	68 20 5b 11 80       	push   $0x80115b20
801041c8:	e8 63 04 00 00       	call   80104630 <release>
}
...
801041e9:	bb c0 5b 11 80       	mov    $0x80115bc0,%ebx
...
80104228:	8b 14 85 2c 7b 10 80 	mov    -0x7fef84d4(,%eax,4),%edx
      state = "???";
...
80104265:	e8 76 02 00 00       	call   801044e0 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
int numprocess(void){
  ...
  struct proc* p;
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042a0:	b8 54 5b 11 80       	mov    $0x80115b54,%eax
  int n=0;
801042a5:	31 d2                	xor    %edx,%edx
801042a7:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
801042ae:	66 90                	xchg   %ax,%ax
    if(p->state == RUNNABLE)
      n++;
801042b0:	31 c9                	xor    %ecx,%ecx
801042b2:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
801042b6:	0f 94 c1             	sete   %cl
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042b9:	83 c0 7c             	add    $0x7c,%eax
      n++;
801042bc:	01 ca                	add    %ecx,%edx
  for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801042be:	3d 54 7a 11 80       	cmp    $0x80117a54,%eax
801042c3:	75 eb                	jne    801042b0 <numprocess+0x10>

  return n;
}
801042c5:	89 d0                	mov    %edx,%eax
801042c7:	c3                   	ret    
...
801042d4:	83 ec 04             	sub    $0x4,%esp
  pushcli();
801042d7:	e8 64 02 00 00       	call   80104540 <pushcli>
  c = mycpu();
801042dc:	e8 0f f6 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
801042e1:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801042e7:	e8 a4 02 00 00       	call   80104590 <popcli>
  uint sz;
  struct proc *curproc = myproc();
  sz = curproc->sz;
  return sz;
...
80104303:	57                   	push   %edi
  struct proc *curproc = myproc();
  pde_t *pga = curproc->pgdir;
  // uint sz = curproc->sz;
  int count=0;

  for(int pdindex=0; pdindex<NPDENTRIES; pdindex++){
...
80104308:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
8010430b:	e8 30 02 00 00       	call   80104540 <pushcli>
  c = mycpu();
80104310:	e8 db f5 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104315:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010431b:	e8 70 02 00 00       	call   80104590 <popcli>
  int count=0;
80104320:	31 d2                	xor    %edx,%edx
  pde_t *pga = curproc->pgdir;
80104322:	8b 73 04             	mov    0x4(%ebx),%esi
  for(int pdindex=0; pdindex<NPDENTRIES; pdindex++){
80104325:	eb 14                	jmp    8010433b <pasize+0x3b>
80104327:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
8010432e:	66 90                	xchg   %ax,%ax
80104330:	83 c7 01             	add    $0x1,%edi
80104333:	81 ff 00 04 00 00    	cmp    $0x400,%edi
80104339:	74 42                	je     8010437d <pasize+0x7d>
    if(pga[pdindex] & PTE_P){
8010433b:	8b 0c be             	mov    (%esi,%edi,4),%ecx
8010433e:	f6 c1 01             	test   $0x1,%cl
80104341:	74 ed                	je     80104330 <pasize+0x30>
      pte_t *pta = (pte_t*)P2V(PTE_ADDR(pga[pdindex]));
80104343:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
      for(int ptindex=0; ptindex<NPTENTRIES; ptindex++){
        if(pta[ptindex] & PTE_P){
          if(pdindex<(KERNBASE>>22))
80104349:	81 ff ff 01 00 00    	cmp    $0x1ff,%edi
      pte_t *pta = (pte_t*)P2V(PTE_ADDR(pga[pdindex]));
8010434f:	8d 81 00 00 00 80    	lea    -0x80000000(%ecx),%eax
          if(pdindex<(KERNBASE>>22))
80104355:	0f 9e c3             	setle  %bl
80104358:	81 e9 00 f0 ff 7f    	sub    $0x7ffff000,%ecx
8010435e:	66 90                	xchg   %ax,%ax
80104360:	f6 00 01             	testb  $0x1,(%eax)
80104363:	74 06                	je     8010436b <pasize+0x6b>
            count++;
80104365:	80 fb 01             	cmp    $0x1,%bl
80104368:	83 da ff             	sbb    $0xffffffff,%edx
      for(int ptindex=0; ptindex<NPTENTRIES; ptindex++){
8010436b:	83 c0 04             	add    $0x4,%eax
8010436e:	39 c1                	cmp    %eax,%ecx
80104370:	75 ee                	jne    80104360 <pasize+0x60>
  for(int pdindex=0; pdindex<NPDENTRIES; pdindex++){
80104372:	83 c7 01             	add    $0x1,%edi
80104375:	81 ff 00 04 00 00    	cmp    $0x400,%edi
8010437b:	75 be                	jne    8010433b <pasize+0x3b>
    }
...
8010439a:	68 44 7b 10 80       	push   $0x80107b44
...
801043f5:	e8 46 fc ff ff       	call   80104040 <sleep>
  while (lk->locked) {
...
80104403:	c7 03 01 00 00 00    	movl   $0x1,(%ebx)
  lk->pid = myproc()->pid;
80104409:	e8 62 f5 ff ff       	call   80103970 <myproc>
...
80104454:	e8 a7 fc ff ff       	call   80104100 <wakeup>
  release(&lk->lk);
...
801044ab:	e8 c0 f4 ff ff       	call   80103970 <myproc>
...
801045d5:	68 4f 7b 10 80       	push   $0x80107b4f
801045da:	e8 a1 bd ff ff       	call   80100380 <panic>
    panic("popcli");
801045df:	83 ec 0c             	sub    $0xc,%esp
801045e2:	68 66 7b 10 80       	push   $0x80107b66
...
8010464b:	68 6d 7b 10 80       	push   $0x80107b6d
...
801046cc:	e8 1f f2 ff ff       	call   801038f0 <mycpu>
...
80104740:	68 75 7b 10 80       	push   $0x80107b75
...
801049c7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801049ca:	e8 a1 ef ff ff       	call   80103970 <myproc>
...
80104a23:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a26:	e8 45 ef ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a66:	83 ec 0c             	sub    $0xc,%esp
  int i;
  struct proc *curproc = myproc();
80104a69:	e8 02 ef ff ff       	call   80103970 <myproc>
80104a6e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a70:	e8 fb ee ff ff       	call   80103970 <myproc>
...
80104a7e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a81:	e8 ea ee ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ad4:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104ad5:	e8 96 ee ff ff       	call   80103970 <myproc>
...
80104ae3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104ae6:	e8 85 ee ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104afb:	8b 5b 04             	mov    0x4(%ebx),%ebx
  struct proc *curproc = myproc();
80104afe:	e8 6d ee ff ff       	call   80103970 <myproc>
  if(addr >= curproc->sz)
...
80104b54:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104b57:	e8 14 ee ff ff       	call   80103970 <myproc>
...
80104b67:	83 fa 22             	cmp    $0x22,%edx
80104b6a:	77 24                	ja     80104b90 <syscall+0x40>
80104b6c:	8b 14 85 a0 7b 10 80 	mov    -0x7fef8460(,%eax,4),%edx
...
80104b98:	68 7d 7b 10 80       	push   $0x80107b7d
...
80104cf4:	68 4c 7c 10 80       	push   $0x80107c4c
...
80104d0c:	68 4b 7c 10 80       	push   $0x80107c4b
...
80104d21:	68 3f 7c 10 80       	push   $0x80107c3f
...
80104d3f:	68 4e 7c 10 80       	push   $0x80107c4e
80104d44:	e8 37 b6 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104d49:	83 ec 0c             	sub    $0xc,%esp
80104d4c:	68 30 7c 10 80       	push   $0x80107c30
...
80104d80:	e8 eb eb ff ff       	call   80103970 <myproc>
...
80104e80:	e8 eb ea ff ff       	call   80103970 <myproc>
...
80104f11:	74 25                	je     80104f38 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104f13:	e8 58 ea ff ff       	call   80103970 <myproc>
  fileclose(f);
...
80104f60:	e8 0b ea ff ff       	call   80103970 <myproc>
...
8010514d:	58                   	pop    %eax
8010514e:	5a                   	pop    %edx
8010514f:	68 4c 7c 10 80       	push   $0x80107c4c
...
80105168:	68 4b 7c 10 80       	push   $0x80107c4b
...
80105357:	74 23                	je     8010537c <sys_open+0x9c>
  struct proc *curproc = myproc();
80105359:	e8 12 e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105515:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105518:	e8 53 e4 ff ff       	call   80103970 <myproc>
...
801056e7:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801056e9:	e8 82 e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105727:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
8010572a:	e8 41 e2 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105746:	75 f0                	jne    80105738 <sys_pipe+0x88>
      myproc()->ofile[fd0] = 0;
80105748:	e8 23 e2 ff ff       	call   80103970 <myproc>
...
{
  return fork();
80105780:	e9 8b e3 ff ff       	jmp    80103b10 <fork>
...
80105793:	83 ec 08             	sub    $0x8,%esp
  exit(); 
80105796:	e8 f5 e5 ff ff       	call   80103d90 <exit>
...
{
  return wait();
801057a0:	e9 1b e7 ff ff       	jmp    80103ec0 <wait>
...
801057ce:	e8 8d e9 ff ff       	call   80104160 <kill>
...
801057f3:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
801057f6:	e8 75 e1 ff ff       	call   80103970 <myproc>
...
80105817:	78 27                	js     80105840 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105819:	e8 52 e1 ff ff       	call   80103970 <myproc>
  if(growproc(n) < 0)
...
80105826:	e8 65 e2 ff ff       	call   80103a90 <growproc>
...
80105870:	68 80 7a 11 80       	push   $0x80117a80
80105875:	e8 16 ee ff ff       	call   80104690 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010587a:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
8010587d:	8b 1d 60 7a 11 80    	mov    0x80117a60,%ebx
  while(ticks - ticks0 < n){
...
80105893:	68 80 7a 11 80       	push   $0x80117a80
80105898:	68 60 7a 11 80       	push   $0x80117a60
8010589d:	e8 9e e7 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
801058a2:	a1 60 7a 11 80       	mov    0x80117a60,%eax
...
801058af:	73 2f                	jae    801058e0 <sys_sleep+0x90>
    if(myproc()->killed){
801058b1:	e8 ba e0 ff ff       	call   80103970 <myproc>
...
801058c0:	68 80 7a 11 80       	push   $0x80117a80
...
801058e3:	68 80 7a 11 80       	push   $0x80117a80
...
80105904:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105907:	68 80 7a 11 80       	push   $0x80117a80
8010590c:	e8 7f ed ff ff       	call   80104690 <acquire>
  xticks = ticks;
80105911:	8b 1d 60 7a 11 80    	mov    0x80117a60,%ebx
  release(&tickslock);
80105917:	c7 04 24 80 7a 11 80 	movl   $0x80117a80,(%esp)
...
80105936:	68 94 7c 10 80       	push   $0x80107c94
...
int sys_numberofprocesses(void){
  return numprocess();
80105950:	e9 4b e9 ff ff       	jmp    801042a0 <numprocess>
...
8010596f:	e8 9c f0 ff ff       	call   80104a10 <argint>
  argptr(1, (void*)&pids, n*sizeof(pids[0]));
80105974:	8b 45 e0             	mov    -0x20(%ebp),%eax
80105977:	83 c4 0c             	add    $0xc,%esp
8010597a:	c1 e0 02             	shl    $0x2,%eax
8010597d:	50                   	push   %eax
8010597e:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105981:	50                   	push   %eax
80105982:	6a 01                	push   $0x1
80105984:	e8 d7 f0 ff ff       	call   80104a60 <argptr>

  for(int i=0; i<n; i++){
80105989:	8b 4d e0             	mov    -0x20(%ebp),%ecx
8010598c:	83 c4 10             	add    $0x10,%esp
8010598f:	85 c9                	test   %ecx,%ecx
80105991:	7e 31                	jle    801059c4 <sys_spawn+0x64>
    pids[i] = fork();
80105993:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  for(int i=0; i<n; i++){
80105996:	31 db                	xor    %ebx,%ebx
  int k=0;
80105998:	31 f6                	xor    %esi,%esi
8010599a:	eb 14                	jmp    801059b0 <sys_spawn+0x50>
8010599c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(pids[i] >0){
      k++;  
801059a0:	0f 9f c2             	setg   %dl
  for(int i=0; i<n; i++){
801059a3:	83 c3 01             	add    $0x1,%ebx
      k++;  
801059a6:	0f b6 d2             	movzbl %dl,%edx
801059a9:	01 d6                	add    %edx,%esi
  for(int i=0; i<n; i++){
801059ab:	39 5d e0             	cmp    %ebx,-0x20(%ebp)
801059ae:	7e 16                	jle    801059c6 <sys_spawn+0x66>
    pids[i] = fork();
801059b0:	8d 3c 98             	lea    (%eax,%ebx,4),%edi
801059b3:	e8 58 e1 ff ff       	call   80103b10 <fork>
801059b8:	89 07                	mov    %eax,(%edi)
    if(pids[i]==0){
801059ba:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801059bd:	8b 14 98             	mov    (%eax,%ebx,4),%edx
801059c0:	85 d2                	test   %edx,%edx
801059c2:	75 dc                	jne    801059a0 <sys_spawn+0x40>
  int k=0;
...
801059dc:	e8 2f f0 ff ff       	call   80104a10 <argint>
  return vasize(id);
801059e1:	58                   	pop    %eax
801059e2:	ff 75 f4             	push   -0xc(%ebp)
801059e5:	e8 e6 e8 ff ff       	call   801042d0 <vasize>
...
801059fc:	e8 0f f0 ff ff       	call   80104a10 <argint>
  pde_t *pde;
  pte_t *pgtab;
...
80105a09:	8b 40 04             	mov    0x4(%eax),%eax
  pde = &curproc->pgdir[PDX(loc)];
80105a0c:	89 d1                	mov    %edx,%ecx
80105a0e:	c1 e9 16             	shr    $0x16,%ecx
  pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105a11:	8b 04 88             	mov    (%eax,%ecx,4),%eax
  
  pte_t pte = pgtab[PTX(loc)];
80105a14:	89 d1                	mov    %edx,%ecx
  loc = (loc & 0xFFF);
80105a16:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
  pte_t pte = pgtab[PTX(loc)];
80105a1c:	c1 e9 0c             	shr    $0xc,%ecx
  pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80105a1f:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  pte_t pte = pgtab[PTX(loc)];
80105a24:	81 e1 ff 03 00 00    	and    $0x3ff,%ecx
  return (loc+PTE_ADDR(pte));
80105a2a:	8b 84 88 00 00 00 80 	mov    -0x80000000(%eax,%ecx,4),%eax

}
80105a31:	c9                   	leave  
  return (loc+PTE_ADDR(pte));
80105a32:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80105a37:	09 d0                	or     %edx,%eax
}
80105a39:	c3                   	ret    
80105a3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi

80105a40 <sys_get_pgtb_size>:
...
80105a44:	83 ec 04             	sub    $0x4,%esp
  struct proc *curproc = myproc();
80105a47:	e8 24 df ff ff       	call   80103970 <myproc>
  // pde_t *pde = &curproc->pgdir[PDX()];
  // pde_t *pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
  int count = 0;
80105a4c:	31 c9                	xor    %ecx,%ecx
80105a4e:	8b 40 04             	mov    0x4(%eax),%eax
80105a51:	8d 98 00 10 00 00    	lea    0x1000(%eax),%ebx
...
80105a62:	83 e2 01             	and    $0x1,%edx
      count++;
80105a65:	83 fa 01             	cmp    $0x1,%edx
80105a68:	83 d9 ff             	sbb    $0xffffffff,%ecx
  for(int i=0; i<1024; i++){
80105a6b:	83 c0 04             	add    $0x4,%eax
80105a6e:	39 d8                	cmp    %ebx,%eax
80105a70:	75 ee                	jne    80105a60 <sys_get_pgtb_size+0x20>
    }
  }
...
80105a80 <sys_get_usr_pgtb_size>:
...
80105a97:	90                   	nop
    if(*pid & PTE_P){
      if(i<(KERNBASE>>22))
80105a98:	3d ff 01 00 00       	cmp    $0x1ff,%eax
80105a9d:	0f 9e c2             	setle  %dl
80105aa0:	22 14 81             	and    (%ecx,%eax,4),%dl
  for(int i=0; i<1024; i++){
80105aa3:	83 c0 01             	add    $0x1,%eax
      if(i<(KERNBASE>>22))
80105aa6:	84 d2                	test   %dl,%dl
80105aa8:	75 16                	jne    80105ac0 <sys_get_usr_pgtb_size+0x40>
  for(int i=0; i<1024; i++){
80105aaa:	3d 00 04 00 00       	cmp    $0x400,%eax
80105aaf:	75 e7                	jne    80105a98 <sys_get_usr_pgtb_size+0x18>
    }
  }
...
80105ab1:	89 d8                	mov    %ebx,%eax
80105ab3:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105ab6:	c9                   	leave  
80105ab7:	c3                   	ret    
...
80105ac0:	83 c3 01             	add    $0x1,%ebx
  for(int i=0; i<1024; i++){
80105ac3:	eb d3                	jmp    80105a98 <sys_get_usr_pgtb_size+0x18>
80105ac5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
80105acc:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi

80105ad0 <sys_get_kernel_pgtb_size>:

int sys_get_kernel_pgtb_size(void){
80105ad0:	55                   	push   %ebp
80105ad1:	89 e5                	mov    %esp,%ebp
80105ad3:	53                   	push   %ebx
80105ad4:	83 ec 04             	sub    $0x4,%esp
  struct proc *curproc = myproc();
80105ad7:	e8 94 de ff ff       	call   80103970 <myproc>
  int count = 0;
  pde_t *pid;
  for(int i=0; i<1024; i++){
80105adc:	31 d2                	xor    %edx,%edx
  struct proc *curproc = myproc();
80105ade:	89 c3                	mov    %eax,%ebx
  int count = 0;
80105ae0:	31 c0                	xor    %eax,%eax
80105ae2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  for(int i=0; i<1024; i++){
80105ae8:	83 c2 01             	add    $0x1,%edx
80105aeb:	81 fa 00 04 00 00    	cmp    $0x400,%edx
80105af1:	74 23                	je     80105b16 <sys_get_kernel_pgtb_size+0x46>
    pid = &curproc->pgdir[i];
    if(*pid & PTE_P){
80105af3:	8b 4b 04             	mov    0x4(%ebx),%ecx
      if(i>=(KERNBASE>>22))
80105af6:	f6 04 91 01          	testb  $0x1,(%ecx,%edx,4)
80105afa:	74 ec                	je     80105ae8 <sys_get_kernel_pgtb_size+0x18>
80105afc:	81 fa ff 01 00 00    	cmp    $0x1ff,%edx
80105b02:	0f 9f c1             	setg   %cl
        count++;
80105b05:	80 f9 01             	cmp    $0x1,%cl
80105b08:	83 d8 ff             	sbb    $0xffffffff,%eax
  for(int i=0; i<1024; i++){
80105b0b:	83 c2 01             	add    $0x1,%edx
80105b0e:	81 fa 00 04 00 00    	cmp    $0x400,%edx
80105b14:	75 dd                	jne    80105af3 <sys_get_kernel_pgtb_size+0x23>
    }
  }
...
80105b16:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105b19:	c9                   	leave  
80105b1a:	c3                   	ret    
80105b1b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80105b1f:	90                   	nop

80105b20 <sys_getpasize>:
...
80105b2c:	e8 df ee ff ff       	call   80104a10 <argint>
  return pasize(pid);
80105b31:	58                   	pop    %eax
80105b32:	ff 75 f4             	push   -0xc(%ebp)
80105b35:	e8 c6 e7 ff ff       	call   80104300 <pasize>
}
80105b3a:	c9                   	leave  
80105b3b:	c3                   	ret    
...
80105b44:	83 ec 14             	sub    $0x14,%esp
  ...
  // char *mem;
  struct proc *curproc = myproc();
80105b47:	e8 24 de ff ff       	call   80103970 <myproc>
  argint(0, &inc);
80105b4c:	83 ec 08             	sub    $0x8,%esp
  struct proc *curproc = myproc();
80105b4f:	89 c3                	mov    %eax,%ebx
  argint(0, &inc);
80105b51:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105b54:	50                   	push   %eax
80105b55:	6a 00                	push   $0x0
80105b57:	e8 b4 ee ff ff       	call   80104a10 <argint>
  if((uint) inc % PGSIZE != 0){
80105b5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b5f:	83 c4 10             	add    $0x10,%esp
80105b62:	a9 ff 0f 00 00       	test   $0xfff,%eax
80105b67:	75 0d                	jne    80105b76 <sys_mmap+0x36>
      panic("loaduvm: addr must be page aligned");
      exit();
  }
  int addr = curproc->sz;
80105b69:	8b 13                	mov    (%ebx),%edx
  curproc->sz = addr+inc;
80105b6b:	01 d0                	add    %edx,%eax
80105b6d:	89 03                	mov    %eax,(%ebx)
  return addr;

80105b6f:	89 d0                	mov    %edx,%eax
80105b71:	8b 5d fc             	mov    -0x4(%ebp),%ebx
80105b74:	c9                   	leave  
80105b75:	c3                   	ret    
      panic("loaduvm: addr must be page aligned");
80105b76:	83 ec 0c             	sub    $0xc,%esp
80105b79:	68 b8 7c 10 80       	push   $0x80107cb8
80105b7e:	e8 fd a7 ff ff       	call   80100380 <panic>
...
80105b84:	06                   	push   %es
  pushl %fs
80105b85:	0f a0                	push   %fs
  pushl %gs
80105b87:	0f a8                	push   %gs
  pushal
80105b89:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
80105b8a:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
80105b8e:	8e d8                	mov    %eax,%ds
  movw %ax, %es
80105b90:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
80105b92:	54                   	push   %esp
  call trap
80105b93:	e8 c8 00 00 00       	call   80105c60 <trap>
  addl $4, %esp
80105b98:	83 c4 04             	add    $0x4,%esp
...
80105b9b:	61                   	popa   
  popl %gs
80105b9c:	0f a9                	pop    %gs
  popl %fs
80105b9e:	0f a1                	pop    %fs
  popl %es
80105ba0:	07                   	pop    %es
  popl %ds
80105ba1:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
80105ba2:	83 c4 08             	add    $0x8,%esp
  iret
80105ba5:	cf                   	iret   
...
80105bc7:	c7 04 c5 c2 7a 11 80 	movl   $0x8e000008,-0x7fee853e(,%eax,8)
80105bce:	08 00 00 8e 
80105bd2:	66 89 14 c5 c0 7a 11 	mov    %dx,-0x7fee8540(,%eax,8)
80105bd9:	80 
80105bda:	c1 ea 10             	shr    $0x10,%edx
80105bdd:	66 89 14 c5 c6 7a 11 	mov    %dx,-0x7fee853a(,%eax,8)
80105be4:	80 
  for(i = 0; i < 256; i++)
...
80105bf7:	c7 05 c2 7c 11 80 08 	movl   $0xef000008,0x80117cc2
80105bfe:	00 00 ef 
  initlock(&tickslock, "time");
80105c01:	68 db 7c 10 80       	push   $0x80107cdb
80105c06:	68 80 7a 11 80       	push   $0x80117a80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105c0b:	66 a3 c0 7c 11 80    	mov    %ax,0x80117cc0
80105c11:	c1 e8 10             	shr    $0x10,%eax
80105c14:	66 a3 c6 7c 11 80    	mov    %ax,0x80117cc6
  initlock(&tickslock, "time");
80105c1a:	e8 a1 e8 ff ff       	call   801044c0 <initlock>
}
...
80105c3b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80105c3f:	b8 c0 7a 11 80       	mov    $0x80117ac0,%eax
...
80105c84:	ff 24 85 84 7d 10 80 	jmp    *-0x7fef827c(,%eax,4)
...
80105d65:	68 40 7d 10 80       	push   $0x80107d40
...
80105d94:	0f 85 3e ff ff ff    	jne    80105cd8 <trap+0x78>
    yield();
80105d9a:	e8 51 e2 ff ff       	call   80103ff0 <yield>
...
80105db7:	68 e8 7c 10 80       	push   $0x80107ce8
...
80105df5:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105df8:	e8 53 ed ff ff       	call   80104b50 <syscall>
    if(myproc()->killed)
...
80105e13:	5d                   	pop    %ebp
      exit();
80105e14:	e9 77 df ff ff       	jmp    80103d90 <exit>
...
80105e70:	68 80 7a 11 80       	push   $0x80117a80
80105e75:	e8 16 e8 ff ff       	call   80104690 <acquire>
      wakeup(&ticks);
80105e7a:	c7 04 24 60 7a 11 80 	movl   $0x80117a60,(%esp)
      ticks++;
80105e81:	83 05 60 7a 11 80 01 	addl   $0x1,0x80117a60
      wakeup(&ticks);
80105e88:	e8 73 e2 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105e8d:	c7 04 24 80 7a 11 80 	movl   $0x80117a80,(%esp)
80105e94:	e8 97 e7 ff ff       	call   80104630 <release>
...
80105eb2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105eb8:	e8 d3 de ff ff       	call   80103d90 <exit>
...
80105ed3:	68 0c 7d 10 80       	push   $0x80107d0c
80105ed8:	e8 c3 a7 ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105edd:	83 c4 14             	add    $0x14,%esp
80105ee0:	68 e0 7c 10 80       	push   $0x80107ce0
...
{
  if(!uart)
80105ef0:	a1 c0 82 11 80       	mov    0x801182c0,%eax
...
80105f77:	74 78                	je     80105ff1 <uartinit+0xd1>
  uart = 1;
80105f79:	c7 05 c0 82 11 80 01 	movl   $0x1,0x801182c0
80105f80:	00 00 00 
...
80105f8c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105f8f:	bf 04 7e 10 80       	mov    $0x80107e04,%edi
...
80105fa9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  if(!uart)
80105fb0:	a1 c0 82 11 80       	mov    0x801182c0,%eax
...
80106000 <uartputc>:
  if(!uart)
80106000:	a1 c0 82 11 80       	mov    0x801182c0,%eax
...
80106077:	6a 00                	push   $0x0
  jmp alltraps
80106079:	e9 05 fb ff ff       	jmp    80105b83 <alltraps>
...
80106080:	6a 01                	push   $0x1
  jmp alltraps
80106082:	e9 fc fa ff ff       	jmp    80105b83 <alltraps>
...
80106089:	6a 02                	push   $0x2
  jmp alltraps
8010608b:	e9 f3 fa ff ff       	jmp    80105b83 <alltraps>
...
80106092:	6a 03                	push   $0x3
  jmp alltraps
80106094:	e9 ea fa ff ff       	jmp    80105b83 <alltraps>
...
8010609b:	6a 04                	push   $0x4
  jmp alltraps
8010609d:	e9 e1 fa ff ff       	jmp    80105b83 <alltraps>
...
801060a4:	6a 05                	push   $0x5
  jmp alltraps
801060a6:	e9 d8 fa ff ff       	jmp    80105b83 <alltraps>
...
801060ad:	6a 06                	push   $0x6
  jmp alltraps
801060af:	e9 cf fa ff ff       	jmp    80105b83 <alltraps>
...
801060b6:	6a 07                	push   $0x7
  jmp alltraps
801060b8:	e9 c6 fa ff ff       	jmp    80105b83 <alltraps>
...
801060bd:	6a 08                	push   $0x8
  jmp alltraps
801060bf:	e9 bf fa ff ff       	jmp    80105b83 <alltraps>
...
801060c6:	6a 09                	push   $0x9
  jmp alltraps
801060c8:	e9 b6 fa ff ff       	jmp    80105b83 <alltraps>
...
801060cd:	6a 0a                	push   $0xa
  jmp alltraps
801060cf:	e9 af fa ff ff       	jmp    80105b83 <alltraps>
...
801060d4:	6a 0b                	push   $0xb
  jmp alltraps
801060d6:	e9 a8 fa ff ff       	jmp    80105b83 <alltraps>
...
801060db:	6a 0c                	push   $0xc
  jmp alltraps
801060dd:	e9 a1 fa ff ff       	jmp    80105b83 <alltraps>
...
801060e2:	6a 0d                	push   $0xd
  jmp alltraps
801060e4:	e9 9a fa ff ff       	jmp    80105b83 <alltraps>
...
801060e9:	6a 0e                	push   $0xe
  jmp alltraps
801060eb:	e9 93 fa ff ff       	jmp    80105b83 <alltraps>
...
801060f2:	6a 0f                	push   $0xf
  jmp alltraps
801060f4:	e9 8a fa ff ff       	jmp    80105b83 <alltraps>
...
801060fb:	6a 10                	push   $0x10
  jmp alltraps
801060fd:	e9 81 fa ff ff       	jmp    80105b83 <alltraps>
...
80106102:	6a 11                	push   $0x11
  jmp alltraps
80106104:	e9 7a fa ff ff       	jmp    80105b83 <alltraps>
...
8010610b:	6a 12                	push   $0x12
  jmp alltraps
8010610d:	e9 71 fa ff ff       	jmp    80105b83 <alltraps>
...
80106114:	6a 13                	push   $0x13
  jmp alltraps
80106116:	e9 68 fa ff ff       	jmp    80105b83 <alltraps>
...
8010611d:	6a 14                	push   $0x14
  jmp alltraps
8010611f:	e9 5f fa ff ff       	jmp    80105b83 <alltraps>
...
80106126:	6a 15                	push   $0x15
  jmp alltraps
80106128:	e9 56 fa ff ff       	jmp    80105b83 <alltraps>
...
8010612f:	6a 16                	push   $0x16
  jmp alltraps
80106131:	e9 4d fa ff ff       	jmp    80105b83 <alltraps>
...
80106138:	6a 17                	push   $0x17
  jmp alltraps
8010613a:	e9 44 fa ff ff       	jmp    80105b83 <alltraps>
...
80106141:	6a 18                	push   $0x18
  jmp alltraps
80106143:	e9 3b fa ff ff       	jmp    80105b83 <alltraps>
...
8010614a:	6a 19                	push   $0x19
  jmp alltraps
8010614c:	e9 32 fa ff ff       	jmp    80105b83 <alltraps>
...
80106153:	6a 1a                	push   $0x1a
  jmp alltraps
80106155:	e9 29 fa ff ff       	jmp    80105b83 <alltraps>
...
8010615c:	6a 1b                	push   $0x1b
  jmp alltraps
8010615e:	e9 20 fa ff ff       	jmp    80105b83 <alltraps>
...
80106165:	6a 1c                	push   $0x1c
  jmp alltraps
80106167:	e9 17 fa ff ff       	jmp    80105b83 <alltraps>
...
8010616e:	6a 1d                	push   $0x1d
  jmp alltraps
80106170:	e9 0e fa ff ff       	jmp    80105b83 <alltraps>
...
80106177:	6a 1e                	push   $0x1e
  jmp alltraps
80106179:	e9 05 fa ff ff       	jmp    80105b83 <alltraps>
...
80106180:	6a 1f                	push   $0x1f
  jmp alltraps
80106182:	e9 fc f9 ff ff       	jmp    80105b83 <alltraps>
...
80106189:	6a 20                	push   $0x20
  jmp alltraps
8010618b:	e9 f3 f9 ff ff       	jmp    80105b83 <alltraps>
...
80106192:	6a 21                	push   $0x21
  jmp alltraps
80106194:	e9 ea f9 ff ff       	jmp    80105b83 <alltraps>
...
8010619b:	6a 22                	push   $0x22
  jmp alltraps
8010619d:	e9 e1 f9 ff ff       	jmp    80105b83 <alltraps>
...
801061a4:	6a 23                	push   $0x23
  jmp alltraps
801061a6:	e9 d8 f9 ff ff       	jmp    80105b83 <alltraps>
...
801061ad:	6a 24                	push   $0x24
  jmp alltraps
801061af:	e9 cf f9 ff ff       	jmp    80105b83 <alltraps>
...
801061b6:	6a 25                	push   $0x25
  jmp alltraps
801061b8:	e9 c6 f9 ff ff       	jmp    80105b83 <alltraps>
...
801061bf:	6a 26                	push   $0x26
  jmp alltraps
801061c1:	e9 bd f9 ff ff       	jmp    80105b83 <alltraps>
...
801061c8:	6a 27                	push   $0x27
  jmp alltraps
801061ca:	e9 b4 f9 ff ff       	jmp    80105b83 <alltraps>
...
801061d1:	6a 28                	push   $0x28
  jmp alltraps
801061d3:	e9 ab f9 ff ff       	jmp    80105b83 <alltraps>
...
801061da:	6a 29                	push   $0x29
  jmp alltraps
801061dc:	e9 a2 f9 ff ff       	jmp    80105b83 <alltraps>
...
801061e3:	6a 2a                	push   $0x2a
  jmp alltraps
801061e5:	e9 99 f9 ff ff       	jmp    80105b83 <alltraps>
...
801061ec:	6a 2b                	push   $0x2b
  jmp alltraps
801061ee:	e9 90 f9 ff ff       	jmp    80105b83 <alltraps>
...
801061f5:	6a 2c                	push   $0x2c
  jmp alltraps
801061f7:	e9 87 f9 ff ff       	jmp    80105b83 <alltraps>
...
801061fe:	6a 2d                	push   $0x2d
  jmp alltraps
80106200:	e9 7e f9 ff ff       	jmp    80105b83 <alltraps>
...
80106207:	6a 2e                	push   $0x2e
  jmp alltraps
80106209:	e9 75 f9 ff ff       	jmp    80105b83 <alltraps>
...
80106210:	6a 2f                	push   $0x2f
  jmp alltraps
80106212:	e9 6c f9 ff ff       	jmp    80105b83 <alltraps>
...
80106219:	6a 30                	push   $0x30
  jmp alltraps
8010621b:	e9 63 f9 ff ff       	jmp    80105b83 <alltraps>
...
80106222:	6a 31                	push   $0x31
  jmp alltraps
80106224:	e9 5a f9 ff ff       	jmp    80105b83 <alltraps>
...
8010622b:	6a 32                	push   $0x32
  jmp alltraps
8010622d:	e9 51 f9 ff ff       	jmp    80105b83 <alltraps>
...
80106234:	6a 33                	push   $0x33
  jmp alltraps
80106236:	e9 48 f9 ff ff       	jmp    80105b83 <alltraps>
...
8010623d:	6a 34                	push   $0x34
  jmp alltraps
8010623f:	e9 3f f9 ff ff       	jmp    80105b83 <alltraps>
...
80106246:	6a 35                	push   $0x35
  jmp alltraps
80106248:	e9 36 f9 ff ff       	jmp    80105b83 <alltraps>
...
8010624f:	6a 36                	push   $0x36
  jmp alltraps
80106251:	e9 2d f9 ff ff       	jmp    80105b83 <alltraps>
...
80106258:	6a 37                	push   $0x37
  jmp alltraps
8010625a:	e9 24 f9 ff ff       	jmp    80105b83 <alltraps>
...
80106261:	6a 38                	push   $0x38
  jmp alltraps
80106263:	e9 1b f9 ff ff       	jmp    80105b83 <alltraps>
...
8010626a:	6a 39                	push   $0x39
  jmp alltraps
8010626c:	e9 12 f9 ff ff       	jmp    80105b83 <alltraps>
...
80106273:	6a 3a                	push   $0x3a
  jmp alltraps
80106275:	e9 09 f9 ff ff       	jmp    80105b83 <alltraps>
...
8010627c:	6a 3b                	push   $0x3b
  jmp alltraps
8010627e:	e9 00 f9 ff ff       	jmp    80105b83 <alltraps>
...
80106285:	6a 3c                	push   $0x3c
  jmp alltraps
80106287:	e9 f7 f8 ff ff       	jmp    80105b83 <alltraps>
...
8010628e:	6a 3d                	push   $0x3d
  jmp alltraps
80106290:	e9 ee f8 ff ff       	jmp    80105b83 <alltraps>
...
80106297:	6a 3e                	push   $0x3e
  jmp alltraps
80106299:	e9 e5 f8 ff ff       	jmp    80105b83 <alltraps>
...
801062a0:	6a 3f                	push   $0x3f
  jmp alltraps
801062a2:	e9 dc f8 ff ff       	jmp    80105b83 <alltraps>
...
801062a9:	6a 40                	push   $0x40
  jmp alltraps
801062ab:	e9 d3 f8 ff ff       	jmp    80105b83 <alltraps>
...
801062b2:	6a 41                	push   $0x41
  jmp alltraps
801062b4:	e9 ca f8 ff ff       	jmp    80105b83 <alltraps>
...
801062bb:	6a 42                	push   $0x42
  jmp alltraps
801062bd:	e9 c1 f8 ff ff       	jmp    80105b83 <alltraps>
...
801062c4:	6a 43                	push   $0x43
  jmp alltraps
801062c6:	e9 b8 f8 ff ff       	jmp    80105b83 <alltraps>
...
801062cd:	6a 44                	push   $0x44
  jmp alltraps
801062cf:	e9 af f8 ff ff       	jmp    80105b83 <alltraps>
...
801062d6:	6a 45                	push   $0x45
  jmp alltraps
801062d8:	e9 a6 f8 ff ff       	jmp    80105b83 <alltraps>
...
801062df:	6a 46                	push   $0x46
  jmp alltraps
801062e1:	e9 9d f8 ff ff       	jmp    80105b83 <alltraps>
...
801062e8:	6a 47                	push   $0x47
  jmp alltraps
801062ea:	e9 94 f8 ff ff       	jmp    80105b83 <alltraps>
...
801062f1:	6a 48                	push   $0x48
  jmp alltraps
801062f3:	e9 8b f8 ff ff       	jmp    80105b83 <alltraps>
...
801062fa:	6a 49                	push   $0x49
  jmp alltraps
801062fc:	e9 82 f8 ff ff       	jmp    80105b83 <alltraps>
...
80106303:	6a 4a                	push   $0x4a
  jmp alltraps
80106305:	e9 79 f8 ff ff       	jmp    80105b83 <alltraps>
...
8010630c:	6a 4b                	push   $0x4b
  jmp alltraps
8010630e:	e9 70 f8 ff ff       	jmp    80105b83 <alltraps>
...
80106315:	6a 4c                	push   $0x4c
  jmp alltraps
80106317:	e9 67 f8 ff ff       	jmp    80105b83 <alltraps>
...
8010631e:	6a 4d                	push   $0x4d
  jmp alltraps
80106320:	e9 5e f8 ff ff       	jmp    80105b83 <alltraps>
...
80106327:	6a 4e                	push   $0x4e
  jmp alltraps
80106329:	e9 55 f8 ff ff       	jmp    80105b83 <alltraps>
...
80106330:	6a 4f                	push   $0x4f
  jmp alltraps
80106332:	e9 4c f8 ff ff       	jmp    80105b83 <alltraps>
...
80106339:	6a 50                	push   $0x50
  jmp alltraps
8010633b:	e9 43 f8 ff ff       	jmp    80105b83 <alltraps>
...
80106342:	6a 51                	push   $0x51
  jmp alltraps
80106344:	e9 3a f8 ff ff       	jmp    80105b83 <alltraps>
...
8010634b:	6a 52                	push   $0x52
  jmp alltraps
8010634d:	e9 31 f8 ff ff       	jmp    80105b83 <alltraps>
...
80106354:	6a 53                	push   $0x53
  jmp alltraps
80106356:	e9 28 f8 ff ff       	jmp    80105b83 <alltraps>
...
8010635d:	6a 54                	push   $0x54
  jmp alltraps
8010635f:	e9 1f f8 ff ff       	jmp    80105b83 <alltraps>
...
80106366:	6a 55                	push   $0x55
  jmp alltraps
80106368:	e9 16 f8 ff ff       	jmp    80105b83 <alltraps>
...
8010636f:	6a 56                	push   $0x56
  jmp alltraps
80106371:	e9 0d f8 ff ff       	jmp    80105b83 <alltraps>
...
80106378:	6a 57                	push   $0x57
  jmp alltraps
8010637a:	e9 04 f8 ff ff       	jmp    80105b83 <alltraps>
...
80106381:	6a 58                	push   $0x58
  jmp alltraps
80106383:	e9 fb f7 ff ff       	jmp    80105b83 <alltraps>
...
8010638a:	6a 59                	push   $0x59
  jmp alltraps
8010638c:	e9 f2 f7 ff ff       	jmp    80105b83 <alltraps>
...
80106393:	6a 5a                	push   $0x5a
  jmp alltraps
80106395:	e9 e9 f7 ff ff       	jmp    80105b83 <alltraps>
...
8010639c:	6a 5b                	push   $0x5b
  jmp alltraps
8010639e:	e9 e0 f7 ff ff       	jmp    80105b83 <alltraps>
...
801063a5:	6a 5c                	push   $0x5c
  jmp alltraps
801063a7:	e9 d7 f7 ff ff       	jmp    80105b83 <alltraps>
...
801063ae:	6a 5d                	push   $0x5d
  jmp alltraps
801063b0:	e9 ce f7 ff ff       	jmp    80105b83 <alltraps>
...
801063b7:	6a 5e                	push   $0x5e
  jmp alltraps
801063b9:	e9 c5 f7 ff ff       	jmp    80105b83 <alltraps>
...
801063c0:	6a 5f                	push   $0x5f
  jmp alltraps
801063c2:	e9 bc f7 ff ff       	jmp    80105b83 <alltraps>
...
801063c9:	6a 60                	push   $0x60
  jmp alltraps
801063cb:	e9 b3 f7 ff ff       	jmp    80105b83 <alltraps>
...
801063d2:	6a 61                	push   $0x61
  jmp alltraps
801063d4:	e9 aa f7 ff ff       	jmp    80105b83 <alltraps>
...
801063db:	6a 62                	push   $0x62
  jmp alltraps
801063dd:	e9 a1 f7 ff ff       	jmp    80105b83 <alltraps>
...
801063e4:	6a 63                	push   $0x63
  jmp alltraps
801063e6:	e9 98 f7 ff ff       	jmp    80105b83 <alltraps>
...
801063ed:	6a 64                	push   $0x64
  jmp alltraps
801063ef:	e9 8f f7 ff ff       	jmp    80105b83 <alltraps>
...
801063f6:	6a 65                	push   $0x65
  jmp alltraps
801063f8:	e9 86 f7 ff ff       	jmp    80105b83 <alltraps>
...
801063ff:	6a 66                	push   $0x66
  jmp alltraps
80106401:	e9 7d f7 ff ff       	jmp    80105b83 <alltraps>
...
80106408:	6a 67                	push   $0x67
  jmp alltraps
8010640a:	e9 74 f7 ff ff       	jmp    80105b83 <alltraps>
...
80106411:	6a 68                	push   $0x68
  jmp alltraps
80106413:	e9 6b f7 ff ff       	jmp    80105b83 <alltraps>
...
8010641a:	6a 69                	push   $0x69
  jmp alltraps
8010641c:	e9 62 f7 ff ff       	jmp    80105b83 <alltraps>
...
80106423:	6a 6a                	push   $0x6a
  jmp alltraps
80106425:	e9 59 f7 ff ff       	jmp    80105b83 <alltraps>
...
8010642c:	6a 6b                	push   $0x6b
  jmp alltraps
8010642e:	e9 50 f7 ff ff       	jmp    80105b83 <alltraps>
...
80106435:	6a 6c                	push   $0x6c
  jmp alltraps
80106437:	e9 47 f7 ff ff       	jmp    80105b83 <alltraps>
...
8010643e:	6a 6d                	push   $0x6d
  jmp alltraps
80106440:	e9 3e f7 ff ff       	jmp    80105b83 <alltraps>
...
80106447:	6a 6e                	push   $0x6e
  jmp alltraps
80106449:	e9 35 f7 ff ff       	jmp    80105b83 <alltraps>
...
80106450:	6a 6f                	push   $0x6f
  jmp alltraps
80106452:	e9 2c f7 ff ff       	jmp    80105b83 <alltraps>
...
80106459:	6a 70                	push   $0x70
  jmp alltraps
8010645b:	e9 23 f7 ff ff       	jmp    80105b83 <alltraps>
...
80106462:	6a 71                	push   $0x71
  jmp alltraps
80106464:	e9 1a f7 ff ff       	jmp    80105b83 <alltraps>
...
8010646b:	6a 72                	push   $0x72
  jmp alltraps
8010646d:	e9 11 f7 ff ff       	jmp    80105b83 <alltraps>
...
80106474:	6a 73                	push   $0x73
  jmp alltraps
80106476:	e9 08 f7 ff ff       	jmp    80105b83 <alltraps>
...
8010647d:	6a 74                	push   $0x74
  jmp alltraps
8010647f:	e9 ff f6 ff ff       	jmp    80105b83 <alltraps>
...
80106486:	6a 75                	push   $0x75
  jmp alltraps
80106488:	e9 f6 f6 ff ff       	jmp    80105b83 <alltraps>
...
8010648f:	6a 76                	push   $0x76
  jmp alltraps
80106491:	e9 ed f6 ff ff       	jmp    80105b83 <alltraps>
...
80106498:	6a 77                	push   $0x77
  jmp alltraps
8010649a:	e9 e4 f6 ff ff       	jmp    80105b83 <alltraps>
...
801064a1:	6a 78                	push   $0x78
  jmp alltraps
801064a3:	e9 db f6 ff ff       	jmp    80105b83 <alltraps>
...
801064aa:	6a 79                	push   $0x79
  jmp alltraps
801064ac:	e9 d2 f6 ff ff       	jmp    80105b83 <alltraps>
...
801064b3:	6a 7a                	push   $0x7a
  jmp alltraps
801064b5:	e9 c9 f6 ff ff       	jmp    80105b83 <alltraps>
...
801064bc:	6a 7b                	push   $0x7b
  jmp alltraps
801064be:	e9 c0 f6 ff ff       	jmp    80105b83 <alltraps>
...
801064c5:	6a 7c                	push   $0x7c
  jmp alltraps
801064c7:	e9 b7 f6 ff ff       	jmp    80105b83 <alltraps>
...
801064ce:	6a 7d                	push   $0x7d
  jmp alltraps
801064d0:	e9 ae f6 ff ff       	jmp    80105b83 <alltraps>
...
801064d7:	6a 7e                	push   $0x7e
  jmp alltraps
801064d9:	e9 a5 f6 ff ff       	jmp    80105b83 <alltraps>
...
801064e0:	6a 7f                	push   $0x7f
  jmp alltraps
801064e2:	e9 9c f6 ff ff       	jmp    80105b83 <alltraps>
...
801064e9:	68 80 00 00 00       	push   $0x80
  jmp alltraps
801064ee:	e9 90 f6 ff ff       	jmp    80105b83 <alltraps>
...
801064f5:	68 81 00 00 00       	push   $0x81
  jmp alltraps
801064fa:	e9 84 f6 ff ff       	jmp    80105b83 <alltraps>
...
80106501:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106506:	e9 78 f6 ff ff       	jmp    80105b83 <alltraps>
...
8010650d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106512:	e9 6c f6 ff ff       	jmp    80105b83 <alltraps>
...
80106519:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010651e:	e9 60 f6 ff ff       	jmp    80105b83 <alltraps>
...
80106525:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010652a:	e9 54 f6 ff ff       	jmp    80105b83 <alltraps>
...
80106531:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106536:	e9 48 f6 ff ff       	jmp    80105b83 <alltraps>
...
8010653d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106542:	e9 3c f6 ff ff       	jmp    80105b83 <alltraps>
...
80106549:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010654e:	e9 30 f6 ff ff       	jmp    80105b83 <alltraps>
...
80106555:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010655a:	e9 24 f6 ff ff       	jmp    80105b83 <alltraps>
...
80106561:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106566:	e9 18 f6 ff ff       	jmp    80105b83 <alltraps>
...
8010656d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106572:	e9 0c f6 ff ff       	jmp    80105b83 <alltraps>
...
80106579:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010657e:	e9 00 f6 ff ff       	jmp    80105b83 <alltraps>
...
80106585:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
8010658a:	e9 f4 f5 ff ff       	jmp    80105b83 <alltraps>
...
80106591:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106596:	e9 e8 f5 ff ff       	jmp    80105b83 <alltraps>
...
8010659d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801065a2:	e9 dc f5 ff ff       	jmp    80105b83 <alltraps>
...
801065a9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801065ae:	e9 d0 f5 ff ff       	jmp    80105b83 <alltraps>
...
801065b5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801065ba:	e9 c4 f5 ff ff       	jmp    80105b83 <alltraps>
...
801065c1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801065c6:	e9 b8 f5 ff ff       	jmp    80105b83 <alltraps>
...
801065cd:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801065d2:	e9 ac f5 ff ff       	jmp    80105b83 <alltraps>
...
801065d9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801065de:	e9 a0 f5 ff ff       	jmp    80105b83 <alltraps>
...
801065e5:	68 95 00 00 00       	push   $0x95
  jmp alltraps
801065ea:	e9 94 f5 ff ff       	jmp    80105b83 <alltraps>
...
801065f1:	68 96 00 00 00       	push   $0x96
  jmp alltraps
801065f6:	e9 88 f5 ff ff       	jmp    80105b83 <alltraps>
...
801065fd:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106602:	e9 7c f5 ff ff       	jmp    80105b83 <alltraps>
...
80106609:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010660e:	e9 70 f5 ff ff       	jmp    80105b83 <alltraps>
...
80106615:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010661a:	e9 64 f5 ff ff       	jmp    80105b83 <alltraps>
...
80106621:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106626:	e9 58 f5 ff ff       	jmp    80105b83 <alltraps>
...
8010662d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106632:	e9 4c f5 ff ff       	jmp    80105b83 <alltraps>
...
80106639:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010663e:	e9 40 f5 ff ff       	jmp    80105b83 <alltraps>
...
80106645:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010664a:	e9 34 f5 ff ff       	jmp    80105b83 <alltraps>
...
80106651:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106656:	e9 28 f5 ff ff       	jmp    80105b83 <alltraps>
...
8010665d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106662:	e9 1c f5 ff ff       	jmp    80105b83 <alltraps>
...
80106669:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010666e:	e9 10 f5 ff ff       	jmp    80105b83 <alltraps>
...
80106675:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010667a:	e9 04 f5 ff ff       	jmp    80105b83 <alltraps>
...
80106681:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
80106686:	e9 f8 f4 ff ff       	jmp    80105b83 <alltraps>
...
8010668d:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106692:	e9 ec f4 ff ff       	jmp    80105b83 <alltraps>
...
80106699:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010669e:	e9 e0 f4 ff ff       	jmp    80105b83 <alltraps>
...
801066a5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801066aa:	e9 d4 f4 ff ff       	jmp    80105b83 <alltraps>
...
801066b1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801066b6:	e9 c8 f4 ff ff       	jmp    80105b83 <alltraps>
...
801066bd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801066c2:	e9 bc f4 ff ff       	jmp    80105b83 <alltraps>
...
801066c9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801066ce:	e9 b0 f4 ff ff       	jmp    80105b83 <alltraps>
...
801066d5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801066da:	e9 a4 f4 ff ff       	jmp    80105b83 <alltraps>
...
801066e1:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
801066e6:	e9 98 f4 ff ff       	jmp    80105b83 <alltraps>
...
801066ed:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
801066f2:	e9 8c f4 ff ff       	jmp    80105b83 <alltraps>
...
801066f9:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
801066fe:	e9 80 f4 ff ff       	jmp    80105b83 <alltraps>
...
80106705:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010670a:	e9 74 f4 ff ff       	jmp    80105b83 <alltraps>
...
80106711:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106716:	e9 68 f4 ff ff       	jmp    80105b83 <alltraps>
...
8010671d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106722:	e9 5c f4 ff ff       	jmp    80105b83 <alltraps>
...
80106729:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010672e:	e9 50 f4 ff ff       	jmp    80105b83 <alltraps>
...
80106735:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010673a:	e9 44 f4 ff ff       	jmp    80105b83 <alltraps>
...
80106741:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106746:	e9 38 f4 ff ff       	jmp    80105b83 <alltraps>
...
8010674d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106752:	e9 2c f4 ff ff       	jmp    80105b83 <alltraps>
...
80106759:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010675e:	e9 20 f4 ff ff       	jmp    80105b83 <alltraps>
...
80106765:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010676a:	e9 14 f4 ff ff       	jmp    80105b83 <alltraps>
...
80106771:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106776:	e9 08 f4 ff ff       	jmp    80105b83 <alltraps>
...
8010677d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
80106782:	e9 fc f3 ff ff       	jmp    80105b83 <alltraps>
...
80106789:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
8010678e:	e9 f0 f3 ff ff       	jmp    80105b83 <alltraps>
...
80106795:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010679a:	e9 e4 f3 ff ff       	jmp    80105b83 <alltraps>
...
801067a1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801067a6:	e9 d8 f3 ff ff       	jmp    80105b83 <alltraps>
...
801067ad:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801067b2:	e9 cc f3 ff ff       	jmp    80105b83 <alltraps>
...
801067b9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801067be:	e9 c0 f3 ff ff       	jmp    80105b83 <alltraps>
...
801067c5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801067ca:	e9 b4 f3 ff ff       	jmp    80105b83 <alltraps>
...
801067d1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801067d6:	e9 a8 f3 ff ff       	jmp    80105b83 <alltraps>
...
801067dd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
801067e2:	e9 9c f3 ff ff       	jmp    80105b83 <alltraps>
...
801067e9:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
801067ee:	e9 90 f3 ff ff       	jmp    80105b83 <alltraps>
...
801067f5:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
801067fa:	e9 84 f3 ff ff       	jmp    80105b83 <alltraps>
...
80106801:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106806:	e9 78 f3 ff ff       	jmp    80105b83 <alltraps>
...
8010680d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106812:	e9 6c f3 ff ff       	jmp    80105b83 <alltraps>
...
80106819:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010681e:	e9 60 f3 ff ff       	jmp    80105b83 <alltraps>
...
80106825:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010682a:	e9 54 f3 ff ff       	jmp    80105b83 <alltraps>
...
80106831:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106836:	e9 48 f3 ff ff       	jmp    80105b83 <alltraps>
...
8010683d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106842:	e9 3c f3 ff ff       	jmp    80105b83 <alltraps>
...
80106849:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010684e:	e9 30 f3 ff ff       	jmp    80105b83 <alltraps>
...
80106855:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010685a:	e9 24 f3 ff ff       	jmp    80105b83 <alltraps>
...
80106861:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106866:	e9 18 f3 ff ff       	jmp    80105b83 <alltraps>
...
8010686d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106872:	e9 0c f3 ff ff       	jmp    80105b83 <alltraps>
...
80106879:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010687e:	e9 00 f3 ff ff       	jmp    80105b83 <alltraps>
...
80106885:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
8010688a:	e9 f4 f2 ff ff       	jmp    80105b83 <alltraps>
...
80106891:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106896:	e9 e8 f2 ff ff       	jmp    80105b83 <alltraps>
...
8010689d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801068a2:	e9 dc f2 ff ff       	jmp    80105b83 <alltraps>
...
801068a9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801068ae:	e9 d0 f2 ff ff       	jmp    80105b83 <alltraps>
...
801068b5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801068ba:	e9 c4 f2 ff ff       	jmp    80105b83 <alltraps>
...
801068c1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801068c6:	e9 b8 f2 ff ff       	jmp    80105b83 <alltraps>
...
801068cd:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801068d2:	e9 ac f2 ff ff       	jmp    80105b83 <alltraps>
...
801068d9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801068de:	e9 a0 f2 ff ff       	jmp    80105b83 <alltraps>
...
801068e5:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
801068ea:	e9 94 f2 ff ff       	jmp    80105b83 <alltraps>
...
801068f1:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
801068f6:	e9 88 f2 ff ff       	jmp    80105b83 <alltraps>
...
801068fd:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106902:	e9 7c f2 ff ff       	jmp    80105b83 <alltraps>
...
80106909:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010690e:	e9 70 f2 ff ff       	jmp    80105b83 <alltraps>
...
80106915:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010691a:	e9 64 f2 ff ff       	jmp    80105b83 <alltraps>
...
80106921:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106926:	e9 58 f2 ff ff       	jmp    80105b83 <alltraps>
...
8010692d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106932:	e9 4c f2 ff ff       	jmp    80105b83 <alltraps>
...
80106939:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010693e:	e9 40 f2 ff ff       	jmp    80105b83 <alltraps>
...
80106945:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010694a:	e9 34 f2 ff ff       	jmp    80105b83 <alltraps>
...
80106951:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106956:	e9 28 f2 ff ff       	jmp    80105b83 <alltraps>
...
8010695d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106962:	e9 1c f2 ff ff       	jmp    80105b83 <alltraps>
...
80106969:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010696e:	e9 10 f2 ff ff       	jmp    80105b83 <alltraps>
...
80106975:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010697a:	e9 04 f2 ff ff       	jmp    80105b83 <alltraps>
...
80106981:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
80106986:	e9 f8 f1 ff ff       	jmp    80105b83 <alltraps>
...
8010698d:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106992:	e9 ec f1 ff ff       	jmp    80105b83 <alltraps>
...
80106999:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010699e:	e9 e0 f1 ff ff       	jmp    80105b83 <alltraps>
...
801069a5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801069aa:	e9 d4 f1 ff ff       	jmp    80105b83 <alltraps>
...
801069b1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801069b6:	e9 c8 f1 ff ff       	jmp    80105b83 <alltraps>
...
801069bd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801069c2:	e9 bc f1 ff ff       	jmp    80105b83 <alltraps>
...
801069c9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801069ce:	e9 b0 f1 ff ff       	jmp    80105b83 <alltraps>
...
801069d5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801069da:	e9 a4 f1 ff ff       	jmp    80105b83 <alltraps>
...
801069e1:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
801069e6:	e9 98 f1 ff ff       	jmp    80105b83 <alltraps>
...
801069ed:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
801069f2:	e9 8c f1 ff ff       	jmp    80105b83 <alltraps>
...
801069f9:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
801069fe:	e9 80 f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a05:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
80106a0a:	e9 74 f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a11:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106a16:	e9 68 f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a1d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106a22:	e9 5c f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a29:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
80106a2e:	e9 50 f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a35:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
80106a3a:	e9 44 f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a41:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106a46:	e9 38 f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a4d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106a52:	e9 2c f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a59:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
80106a5e:	e9 20 f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a65:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
80106a6a:	e9 14 f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a71:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106a76:	e9 08 f1 ff ff       	jmp    80105b83 <alltraps>
...
80106a7d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
80106a82:	e9 fc f0 ff ff       	jmp    80105b83 <alltraps>
...
80106a89:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
80106a8e:	e9 f0 f0 ff ff       	jmp    80105b83 <alltraps>
...
80106a95:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
80106a9a:	e9 e4 f0 ff ff       	jmp    80105b83 <alltraps>
...
80106aa1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106aa6:	e9 d8 f0 ff ff       	jmp    80105b83 <alltraps>
...
80106aad:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106ab2:	e9 cc f0 ff ff       	jmp    80105b83 <alltraps>
...
80106ab9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
80106abe:	e9 c0 f0 ff ff       	jmp    80105b83 <alltraps>
...
80106ac5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
80106aca:	e9 b4 f0 ff ff       	jmp    80105b83 <alltraps>
...
80106ad1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106ad6:	e9 a8 f0 ff ff       	jmp    80105b83 <alltraps>
...
80106add:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106ae2:	e9 9c f0 ff ff       	jmp    80105b83 <alltraps>
...
80106c35:	e8 16 db ff ff       	call   80104750 <memset>
...
80106c7d:	68 0c 7e 10 80       	push   $0x80107e0c
...
80106caa:	c7 80 18 56 11 80 ff 	movl   $0xffff,-0x7feea9e8(%eax)
80106cb1:	ff 00 00 
80106cb4:	c7 80 1c 56 11 80 00 	movl   $0xcf9a00,-0x7feea9e4(%eax)
80106cbb:	9a cf 00 
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80106cbe:	c7 80 20 56 11 80 ff 	movl   $0xffff,-0x7feea9e0(%eax)
80106cc5:	ff 00 00 
80106cc8:	c7 80 24 56 11 80 00 	movl   $0xcf9200,-0x7feea9dc(%eax)
80106ccf:	92 cf 00 
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
80106cd2:	c7 80 28 56 11 80 ff 	movl   $0xffff,-0x7feea9d8(%eax)
80106cd9:	ff 00 00 
80106cdc:	c7 80 2c 56 11 80 00 	movl   $0xcffa00,-0x7feea9d4(%eax)
80106ce3:	fa cf 00 
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
80106ce6:	c7 80 30 56 11 80 ff 	movl   $0xffff,-0x7feea9d0(%eax)
80106ced:	ff 00 00 
80106cf0:	c7 80 34 56 11 80 00 	movl   $0xcff200,-0x7feea9cc(%eax)
80106cf7:	f2 cf 00 
  lgdt(c->gdt, sizeof(c->gdt));
80106cfa:	05 10 56 11 80       	add    $0x80115610,%eax
  pd[1] = (uint)p;
...
80106d20:	a1 c4 82 11 80       	mov    0x801182c4,%eax
...
80106d54:	0f 84 c2 00 00 00    	je     80106e1c <switchuvm+0xec>
  pushcli();
80106d5a:	e8 e1 d7 ff ff       	call   80104540 <pushcli>
...
80106e6f:	e8 dc d8 ff ff       	call   80104750 <memset>
...
80106ea2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106ea3:	e9 48 d9 ff ff       	jmp    801047f0 <memmove>
    panic("inituvm: more than a page");
80106ea8:	83 ec 0c             	sub    $0xc,%esp
80106eab:	68 51 7e 10 80       	push   $0x80107e51
...
80106f10:	68 6b 7e 10 80       	push   $0x80107e6b
...
80106f98:	68 b8 7c 10 80       	push   $0x80107cb8
...
80106ffb:	e8 50 d7 ff ff       	call   80104750 <memset>
...
80107039:	68 89 7e 10 80       	push   $0x80107e89
...
8010709b:	68 a1 7e 10 80       	push   $0x80107ea1
...
8010717c:	68 bd 7e 10 80       	push   $0x80107ebd
...
801071b0:	e8 9b d5 ff ff       	call   80104750 <memset>
...
8010721b:	a3 c4 82 11 80       	mov    %eax,0x801182c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
8010724c:	68 ce 7e 10 80       	push   $0x80107ece
...
801072c2:	68 d8 7e 10 80       	push   $0x80107ed8
...
80107320:	e8 cb d4 ff ff       	call   801047f0 <memmove>
...
80107397:	68 f2 7e 10 80       	push   $0x80107ef2
...
80107450:	e8 9b d3 ff ff       	call   801047f0 <memmove>
    len -= n;
    buf += n;
