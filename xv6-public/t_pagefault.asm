...
000003a3 <getpasize>:
SYSCALL(getpasize)
 3a3:	b8 22 00 00 00       	mov    $0x22,%eax
 3a8:	cd 40                	int    $0x40
 3aa:	c3                   	ret    

000003ab <mmap>:
 3ab:	b8 23 00 00 00       	mov    $0x23,%eax
 3b0:	cd 40                	int    $0x40
 3b2:	c3                   	ret    
 ...
 3cc:	89 d1                	mov    %edx,%ecx
{
 ...
 3f9:	0f b6 92 38 08 00 00 	movzbl 0x838(%edx),%edx
 ...
 479:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4e9:	ff 24 85 e0 07 00 00 	jmp    *0x7e0(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5f7:	90                   	nop
          s = "(null)";
 5f8:	ba d8 07 00 00       	mov    $0x7d8,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 611:	a1 e4 0a 00 00       	mov    0xae4,%eax
{
 ...
 651:	5b                   	pop    %ebx
  freep = p;
 652:	89 15 e4 0a 00 00    	mov    %edx,0xae4
}
 658:	5e                   	pop    %esi
 659:	5f                   	pop    %edi
 65a:	5d                   	pop    %ebp
 ...
 689:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 68c:	89 15 e4 0a 00 00    	mov    %edx,0xae4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 4f                	jae    740 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	8b 3d e4 0a 00 00    	mov    0xae4,%edi
 ...
 71a:	e8 f1 fe ff ff       	call   610 <free>
  return freep;
 71f:	8b 15 e4 0a 00 00    	mov    0xae4,%edx
 ...
 767:	0a 00 00 
    base.s.size = 0;
 76a:	bf e8 0a 00 00       	mov    $0xae8,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 779:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 77b:	c7 05 ec 0a 00 00 00 	movl   $0x0,0xaec
 782:	00 00 00 
    if(p->s.size >= nunits){
