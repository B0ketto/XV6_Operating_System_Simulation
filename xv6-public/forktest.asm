  ...
  44:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  49:	68 64 04 00 00       	push   $0x464
  4e:	e8 5d 01 00 00       	call   1b0 <strlen>
  53:	83 c4 0c             	add    $0xc,%esp
  56:	50                   	push   %eax
  57:	68 64 04 00 00       	push   $0x464
  5c:	6a 01                	push   $0x1
  ...
  ab:	68 96 04 00 00       	push   $0x496
  b0:	e8 fb 00 00 00       	call   1b0 <strlen>
  b5:	83 c4 0c             	add    $0xc,%esp
  b8:	50                   	push   %eax
  b9:	68 96 04 00 00       	push   $0x496
  be:	6a 01                	push   $0x1
  ...
  d2:	68 6f 04 00 00       	push   $0x46f
  d7:	e8 d4 00 00 00       	call   1b0 <strlen>
  dc:	83 c4 0c             	add    $0xc,%esp
  df:	50                   	push   %eax
  e0:	68 6f 04 00 00       	push   $0x46f
  e5:	6a 01                	push   $0x1
...
SYSCALL(get_pgtb_size)
 43b:	b8 1e 00 00 00       	mov    $0x1e,%eax
 440:	cd 40                	int    $0x40
 442:	c3                   	ret    

00000443 <get_usr_pgtb_size>:
SYSCALL(get_usr_pgtb_size)
 443:	b8 1f 00 00 00       	mov    $0x1f,%eax
 448:	cd 40                	int    $0x40
 44a:	c3                   	ret    
