...
0000065b <get_pgtb_size>:
SYSCALL(get_pgtb_size)
 65b:	b8 1e 00 00 00       	mov    $0x1e,%eax
 660:	cd 40                	int    $0x40
 662:	c3                   	ret    

00000663 <get_usr_pgtb_size>:
SYSCALL(get_usr_pgtb_size)
 663:	b8 1f 00 00 00       	mov    $0x1f,%eax
 668:	cd 40                	int    $0x40
 66a:	c3                   	ret    

0000066b <get_kernel_pgtb_size>:
SYSCALL(get_kernel_pgtb_size)
 66b:	b8 20 00 00 00       	mov    $0x20,%eax
 670:	cd 40                	int    $0x40
 672:	c3                   	ret    

00000673 <getpasize>:
SYSCALL(getpasize)
 673:	b8 22 00 00 00       	mov    $0x22,%eax
 678:	cd 40                	int    $0x40
 67a:	c3                   	ret    

0000067b <mmap>:
 67b:	b8 23 00 00 00       	mov    $0x23,%eax
 680:	cd 40                	int    $0x40
 682:	c3                   	ret    
