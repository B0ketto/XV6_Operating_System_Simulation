...
_t_getvasize:     file format elf32-i386
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 50 08 00 00 	jmp    *0x850(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba 48 08 00 00       	mov    $0x848,%edx
        while(*s != 0){
