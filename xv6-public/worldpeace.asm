...
_worldpeace:     file format elf32-i386
...
int main(int argc, char* argv[])
{
   ...
   e:	83 ec 04             	sub    $0x4,%esp
    ...
    worldpeace();
  11:	e8 0d 03 00 00       	call   323 <worldpeace>
    printf(1,"\n");
  ...
  20:	e8 0b 04 00 00       	call   430 <printf>
    exit();
  25:	e8 59 02 00 00       	call   283 <exit>
  2a:	66 90                	xchg   %ax,%ax
  2c:	66 90                	xchg   %ax,%ax
  2e:	66 90                	xchg   %ax,%ax
 ...
 439:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b7:	90                   	nop
          s = "(null)";
 5b8:	ba 5a 07 00 00       	mov    $0x75a,%edx
        while(*s != 0){
 ...
 5d1:	a1 64 0a 00 00       	mov    0xa64,%eax
{
 ...
 649:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 64c:	89 15 64 0a 00 00    	mov    %edx,0xa64
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 669:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 66c:	8b 3d 64 0a 00 00    	mov    0xa64,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6af:	73 4f                	jae    700 <malloc+0xa0>
    ...
    if(p == freep)
 6b1:	8b 3d 64 0a 00 00    	mov    0xa64,%edi
 ...
 6da:	e8 f1 fe ff ff       	call   5d0 <free>
  return freep;
 6df:	8b 15 64 0a 00 00    	mov    0xa64,%edx
 ...
 70c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 70f:	89 15 64 0a 00 00    	mov    %edx,0xa64
}
 ...
 71f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 720:	c7 05 64 0a 00 00 68 	movl   $0xa68,0xa64
 727:	0a 00 00 
    base.s.size = 0;
 72a:	bf 68 0a 00 00       	mov    $0xa68,%edi
    base.s.ptr = freep = prevp = &base;
 72f:	c7 05 68 0a 00 00 68 	movl   $0xa68,0xa68
 736:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 739:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 73b:	c7 05 6c 0a 00 00 00 	movl   $0x0,0xa6c
 742:	00 00 00 
    if(p->s.size >= nunits){
