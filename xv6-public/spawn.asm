  ...
  14:	83 39 01             	cmpl   $0x1,(%ecx)
{
  ...
  22:	e8 f9 02 00 00       	call   320 <atoi>

    int pids[n];
  27:	83 c4 10             	add    $0x10,%esp
  2a:	8d 0c 85 00 00 00 00 	lea    0x0(,%eax,4),%ecx
    int n = atoi(argv[1]);
  31:	89 c3                	mov    %eax,%ebx
    int pids[n];
  33:	89 e6                	mov    %esp,%esi
  35:	8d 41 0f             	lea    0xf(%ecx),%eax
  38:	89 c2                	mov    %eax,%edx
  3a:	25 00 f0 ff ff       	and    $0xfffff000,%eax
  3f:	83 e2 f0             	and    $0xfffffff0,%edx
  42:	29 c6                	sub    %eax,%esi
  44:	39 f4                	cmp    %esi,%esp
  46:	74 24                	je     6c <main+0x6c>
  48:	81 ec 00 10 00 00    	sub    $0x1000,%esp
  4e:	83 8c 24 fc 0f 00 00 	orl    $0x0,0xffc(%esp)
  55:	00 
  56:	eb ec                	jmp    44 <main+0x44>
        printf(1, "Usage: %s <program> [arguments...]\n", argv[0]);
  58:	51                   	push   %ecx
  59:	ff 30                	push   (%eax)
  5b:	68 68 08 00 00       	push   $0x868
  60:	6a 01                	push   $0x1
  62:	e8 d9 04 00 00       	call   540 <printf>
        exit();
  67:	e8 27 03 00 00       	call   393 <exit>
    int pids[n];
  6c:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
  72:	29 d4                	sub    %edx,%esp
  74:	85 d2                	test   %edx,%edx
  76:	74 05                	je     7d <main+0x7d>
  78:	83 4c 14 fc 00       	orl    $0x0,-0x4(%esp,%edx,1)
  7d:	89 e7                	mov    %esp,%edi
    memset(pids, 0, sizeof(pids));
  7f:	56                   	push   %esi
  80:	51                   	push   %ecx
  81:	6a 00                	push   $0x0
  83:	57                   	push   %edi
  84:	e8 77 01 00 00       	call   200 <memset>
  ...
  8b:	57                   	push   %edi
  8c:	53                   	push   %ebx
  8d:	e8 b1 03 00 00       	call   443 <spawn>

    if (num_child < 0)
  92:	89 fc                	mov    %edi,%esp
    int num_child = spawn(n, pids);
  94:	89 c6                	mov    %eax,%esi
    if (num_child < 0)
  96:	85 c0                	test   %eax,%eax
  98:	78 75                	js     10f <main+0x10f>
  ...
  9a:	bb 00 00 00 00       	mov    $0x0,%ebx
    else if (num_child == 0)
  9f:	0f 84 7d 00 00 00    	je     122 <main+0x122>
  a5:	8d 76 00             	lea    0x0(%esi),%esi
        {
            int cpid = wait();
  a8:	e8 ee 02 00 00       	call   39b <wait>
  ...
  b0:	83 c3 01             	add    $0x1,%ebx
            printf(1, "Parent reaped children with id %d successfully\n", cpid);
  b3:	50                   	push   %eax
  b4:	68 8c 08 00 00       	push   $0x88c
  b9:	6a 01                	push   $0x1
  bb:	e8 80 04 00 00       	call   540 <printf>
        for (int i = 0; i < num_child; i++)
  ...
  e3:	ff 34 9f             	push   (%edi,%ebx,4)
        for (int i = 0; i < num_child; i++)
  e6:	83 c3 01             	add    $0x1,%ebx
            printf(1, "%d ", pids[i]);
  e9:	68 f3 08 00 00       	push   $0x8f3
  ee:	6a 01                	push   $0x1
  f0:	e8 4b 04 00 00       	call   540 <printf>
        for (int i = 0; i < num_child; i++)
  f5:	83 c4 10             	add    $0x10,%esp
  f8:	39 de                	cmp    %ebx,%esi
  fa:	7f e4                	jg     e0 <main+0xe0>
 ...
 10f:	53                   	push   %ebx
 110:	53                   	push   %ebx
 111:	68 bc 08 00 00       	push   $0x8bc
 116:	6a 01                	push   $0x1
 118:	e8 23 04 00 00       	call   540 <printf>
        exit();
 11d:	e8 71 02 00 00       	call   393 <exit>
        printf(1,"Hi from spawned child \n");
 122:	51                   	push   %ecx
 123:	51                   	push   %ecx
 124:	68 ca 08 00 00       	push   $0x8ca
 129:	6a 01                	push   $0x1
 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 4c9:	0f b6 92 58 09 00 00 	movzbl 0x958(%edx),%edx
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b9:	ff 24 85 00 09 00 00 	jmp    *0x900(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6c7:	90                   	nop
          s = "(null)";
 6c8:	ba f7 08 00 00       	mov    $0x8f7,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 0c 0c 00 00       	mov    0xc0c,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d 0c 0c 00 00    	mov    0xc0c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d 0c 0c 00 00    	mov    0xc0c,%edi
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 0c 0c 00 00    	mov    0xc0c,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 0c 0c 00 00    	mov    %edx,0xc0c
}
 ...
 82f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 0c 0c 00 00 10 	movl   $0xc10,0xc0c
 837:	0c 00 00 
    base.s.size = 0;
 83a:	bf 10 0c 00 00       	mov    $0xc10,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 10 0c 00 00 10 	movl   $0xc10,0xc10
 846:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 84b:	c7 05 14 0c 00 00 00 	movl   $0x0,0xc14
 852:	00 00 00 
    if(p->s.size >= nunits){
