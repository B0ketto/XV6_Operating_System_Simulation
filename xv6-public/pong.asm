...
int main(int argc, char *argv[]){
  ...
  13:	8b 71 04             	mov    0x4(%ecx),%esi
    ...
    fd = open(argv[1], 0);
  16:	6a 00                	push   $0x0
  18:	ff 76 04             	push   0x4(%esi)
  1b:	e8 83 03 00 00       	call   3a3 <open>
    if(fd<0){
  ...
  27:	78 19                	js     42 <main+0x42>
        printf(1, "COuldn't open file\n");
    }
    wc(fd, argv[1]);
  29:	83 ec 08             	sub    $0x8,%esp
  2c:	ff 76 04             	push   0x4(%esi)
  2f:	53                   	push   %ebx
  30:	e8 2b 00 00 00       	call   60 <wc>

    close(fd);
  35:	89 1c 24             	mov    %ebx,(%esp)
  38:	e8 4e 03 00 00       	call   38b <close>
    exit();
  3d:	e8 21 03 00 00       	call   363 <exit>
        printf(1, "COuldn't open file\n");
  42:	50                   	push   %eax
  43:	50                   	push   %eax
  44:	68 43 08 00 00       	push   $0x843
  49:	6a 01                	push   $0x1
  4b:	e8 c0 04 00 00       	call   510 <printf>
  50:	83 c4 10             	add    $0x10,%esp
  53:	eb d4                	jmp    29 <main+0x29>
  55:	66 90                	xchg   %ax,%ax
  57:	66 90                	xchg   %ax,%ax
  59:	66 90                	xchg   %ax,%ax
  5b:	66 90                	xchg   %ax,%ax
...
wc(int fd, char *name){
  ...
  69:	68 00 02 00 00       	push   $0x200
  6e:	68 c0 0b 00 00       	push   $0xbc0
  73:	ff 75 08             	push   0x8(%ebp)
  76:	e8 00 03 00 00       	call   37b <read>
    for(i=0; i<n; i++){
  7b:	83 c4 10             	add    $0x10,%esp
  7e:	85 c0                	test   %eax,%eax
  80:	7e 5d                	jle    df <wc+0x7f>
  82:	89 c7                	mov    %eax,%edi
    int l=0;
  84:	31 f6                	xor    %esi,%esi
    for(i=0; i<n; i++){
  86:	31 db                	xor    %ebx,%ebx
  88:	eb 16                	jmp    a0 <wc+0x40>
  8a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
            word[l] = buf[i];
  90:	88 86 a0 0b 00 00    	mov    %al,0xba0(%esi)
            l++;
  96:	83 c6 01             	add    $0x1,%esi
    for(i=0; i<n; i++){
  99:	83 c3 01             	add    $0x1,%ebx
  9c:	39 df                	cmp    %ebx,%edi
  9e:	74 3f                	je     df <wc+0x7f>
        if((buf[i]>='a' && buf[i]<='z') || (buf[i]>='A' && buf[i]<='Z')){
  a0:	0f b6 83 c0 0b 00 00 	movzbl 0xbc0(%ebx),%eax
  a7:	89 c2                	mov    %eax,%edx
  a9:	83 e2 df             	and    $0xffffffdf,%edx
  ac:	83 ea 41             	sub    $0x41,%edx
  af:	80 fa 19             	cmp    $0x19,%dl
  b2:	76 dc                	jbe    90 <wc+0x30>
            if(strcmp(word, "ping")==0){
  b4:	83 ec 08             	sub    $0x8,%esp
            word[l] = '\0';
  b7:	c6 86 a0 0b 00 00 00 	movb   $0x0,0xba0(%esi)
            if(strcmp(word, "ping")==0){
  be:	68 38 08 00 00       	push   $0x838
  c3:	68 a0 0b 00 00       	push   $0xba0
  c8:	e8 73 00 00 00       	call   140 <strcmp>
  cd:	83 c4 10             	add    $0x10,%esp
  d0:	89 c6                	mov    %eax,%esi
  d2:	85 c0                	test   %eax,%eax
  d4:	74 1a                	je     f0 <wc+0x90>
    for(i=0; i<n; i++){
  ...
  dd:	75 c1                	jne    a0 <wc+0x40>
}
  df:	8d 65 f4             	lea    -0xc(%ebp),%esp
  e2:	5b                   	pop    %ebx
  e3:	5e                   	pop    %esi
  e4:	5f                   	pop    %edi
  e5:	5d                   	pop    %ebp
...
0000042b <get_pgtb_size>:
SYSCALL(get_pgtb_size)
 42b:	b8 1e 00 00 00       	mov    $0x1e,%eax
 430:	cd 40                	int    $0x40
 432:	c3                   	ret    

00000433 <get_usr_pgtb_size>:
SYSCALL(get_usr_pgtb_size)
 433:	b8 1f 00 00 00       	mov    $0x1f,%eax
 438:	cd 40                	int    $0x40
 43a:	c3                   	ret    

0000043b <get_kernel_pgtb_size>:
SYSCALL(get_kernel_pgtb_size)
 43b:	b8 20 00 00 00       	mov    $0x20,%eax
 440:	cd 40                	int    $0x40
 442:	c3                   	ret    
 ...
 519:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 589:	ff 24 85 60 08 00 00 	jmp    *0x860(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 697:	90                   	nop
          s = "(null)";
 698:	ba 57 08 00 00       	mov    $0x857,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6b1:	a1 c0 0d 00 00       	mov    0xdc0,%eax
{
 ...
 6f1:	5b                   	pop    %ebx
  freep = p;
 6f2:	89 15 c0 0d 00 00    	mov    %edx,0xdc0
}
 6f8:	5e                   	pop    %esi
 6f9:	5f                   	pop    %edi
 6fa:	5d                   	pop    %ebp
 ...
 729:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 72c:	89 15 c0 0d 00 00    	mov    %edx,0xdc0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 749:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 74c:	8b 3d c0 0d 00 00    	mov    0xdc0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 78f:	73 4f                	jae    7e0 <malloc+0xa0>
    ...
    if(p == freep)
 791:	8b 3d c0 0d 00 00    	mov    0xdc0,%edi
 ...
 7ba:	e8 f1 fe ff ff       	call   6b0 <free>
  return freep;
 7bf:	8b 15 c0 0d 00 00    	mov    0xdc0,%edx
 ...
 807:	0d 00 00 
    base.s.size = 0;
 80a:	bf c4 0d 00 00       	mov    $0xdc4,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 819:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 81b:	c7 05 c8 0d 00 00 00 	movl   $0x0,0xdc8
 822:	00 00 00 
    if(p->s.size >= nunits){
