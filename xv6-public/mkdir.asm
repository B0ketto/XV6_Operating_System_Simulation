 ...
 3dc:	89 d1                	mov    %edx,%ecx
{
 ...
 409:	0f b6 92 3c 08 00 00 	movzbl 0x83c(%edx),%edx
 ...
 489:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4f9:	ff 24 85 e4 07 00 00 	jmp    *0x7e4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 607:	90                   	nop
          s = "(null)";
 608:	ba db 07 00 00       	mov    $0x7db,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 621:	a1 f4 0a 00 00       	mov    0xaf4,%eax
{
 ...
 661:	5b                   	pop    %ebx
  freep = p;
 662:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
}
 668:	5e                   	pop    %esi
 669:	5f                   	pop    %edi
 66a:	5d                   	pop    %ebp
 ...
 699:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 69c:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 3d f4 0a 00 00    	mov    0xaf4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ff:	73 4f                	jae    750 <malloc+0xa0>
    ...
    if(p == freep)
 701:	8b 3d f4 0a 00 00    	mov    0xaf4,%edi
 ...
 72a:	e8 f1 fe ff ff       	call   620 <free>
  return freep;
 72f:	8b 15 f4 0a 00 00    	mov    0xaf4,%edx
 ...
 75c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 75f:	89 15 f4 0a 00 00    	mov    %edx,0xaf4
}
 ...
 76f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 770:	c7 05 f4 0a 00 00 f8 	movl   $0xaf8,0xaf4
 777:	0a 00 00 
    base.s.size = 0;
 77a:	bf f8 0a 00 00       	mov    $0xaf8,%edi
    base.s.ptr = freep = prevp = &base;
 77f:	c7 05 f8 0a 00 00 f8 	movl   $0xaf8,0xaf8
 786:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 789:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 78b:	c7 05 fc 0a 00 00 00 	movl   $0x0,0xafc
 792:	00 00 00 
    if(p->s.size >= nunits){
