...
int main(int argc, char *argv[]){
   ...
   f:	8b 59 04             	mov    0x4(%ecx),%ebx
    ...
    // argv[argc] = "\0
    int pid = fork();
  12:	e8 94 02 00 00       	call   2ab <fork>
    if(pid<0){
  17:	85 c0                	test   %eax,%eax
  19:	78 2d                	js     48 <main+0x48>
        printf(1, "child process\n");
        exit();
    }else if(pid == 0){
  1b:	75 21                	jne    3e <main+0x3e>
        exec(argv[1], argv+1);
  1d:	50                   	push   %eax
  1e:	50                   	push   %eax
  1f:	8d 43 04             	lea    0x4(%ebx),%eax
  22:	50                   	push   %eax
  23:	ff 73 04             	push   0x4(%ebx)
  26:	e8 c0 02 00 00       	call   2eb <exec>
        printf(1,"Exec failed");
  2b:	5a                   	pop    %edx
  2c:	59                   	pop    %ecx
  2d:	68 97 07 00 00       	push   $0x797
  32:	6a 01                	push   $0x1
  34:	e8 27 04 00 00       	call   460 <printf>
        exit();
  39:	e8 75 02 00 00       	call   2b3 <exit>
    }else{
        wait();
  3e:	e8 78 02 00 00       	call   2bb <wait>
    }
    exit();
  ...
  48:	53                   	push   %ebx
  49:	53                   	push   %ebx
  4a:	68 88 07 00 00       	push   $0x788
  4f:	6a 01                	push   $0x1
  51:	e8 0a 04 00 00       	call   460 <printf>
        exit();
  56:	e8 58 02 00 00       	call   2b3 <exit>
  5b:	66 90                	xchg   %ax,%ax
  5d:	66 90                	xchg   %ax,%ax
  5f:	90                   	nop
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 ac 07 00 00 	jmp    *0x7ac(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba a3 07 00 00       	mov    $0x7a3,%edx
        while(*s != 0){
 ...
 601:	a1 b0 0a 00 00       	mov    0xab0,%eax
{
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 b0 0a 00 00    	mov    %edx,0xab0
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d b0 0a 00 00    	mov    0xab0,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 b0 0a 00 00    	mov    0xab0,%edx
 ...
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf b4 0a 00 00       	mov    $0xab4,%edi
    base.s.ptr = freep = prevp = &base;
 ...
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 b8 0a 00 00 00 	movl   $0x0,0xab8
 772:	00 00 00 
    if(p->s.size >= nunits){
