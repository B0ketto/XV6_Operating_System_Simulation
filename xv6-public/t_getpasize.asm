...
int main(int argc, char *argv[])
{
  ...
  8d:	53                   	push   %ebx
  8e:	68 68 08 00 00       	push   $0x868
  93:	6a 01                	push   $0x1
  95:	e8 06 04 00 00       	call   4a0 <printf>
    exit();
 ...
 3fc:	89 d1                	mov    %edx,%ecx
{
 ...
 429:	0f b6 92 0c 09 00 00 	movzbl 0x90c(%edx),%edx
 ...
 4a9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 519:	ff 24 85 b4 08 00 00 	jmp    *0x8b4(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 627:	90                   	nop
          s = "(null)";
 628:	ba ac 08 00 00       	mov    $0x8ac,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 641:	a1 b8 0b 00 00       	mov    0xbb8,%eax
{
 ...
 681:	5b                   	pop    %ebx
  freep = p;
 682:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
}
 688:	5e                   	pop    %esi
 689:	5f                   	pop    %edi
 68a:	5d                   	pop    %ebp
 ...
 6b9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6bc:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6d9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6dc:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 71f:	73 4f                	jae    770 <malloc+0xa0>
    ...
    if(p == freep)
 721:	8b 3d b8 0b 00 00    	mov    0xbb8,%edi
 ...
 74a:	e8 f1 fe ff ff       	call   640 <free>
  return freep;
 74f:	8b 15 b8 0b 00 00    	mov    0xbb8,%edx
 ...
 77c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 77f:	89 15 b8 0b 00 00    	mov    %edx,0xbb8
}
 ...
 78f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 790:	c7 05 b8 0b 00 00 bc 	movl   $0xbbc,0xbb8
 797:	0b 00 00 
    base.s.size = 0;
 79a:	bf bc 0b 00 00       	mov    $0xbbc,%edi
    base.s.ptr = freep = prevp = &base;
 79f:	c7 05 bc 0b 00 00 bc 	movl   $0xbbc,0xbbc
 7a6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7a9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7ab:	c7 05 c0 0b 00 00 00 	movl   $0x0,0xbc0
 7b2:	00 00 00 
    if(p->s.size >= nunits){
