...
_t_va_to_pa1:     file format elf32-i386
   ...
   f:	8d 5d f4             	lea    -0xc(%ebp),%ebx
{
  ...
  1c:	53                   	push   %ebx
  1d:	e8 b1 03 00 00       	call   3d3 <va_to_pa>
  22:	50                   	push   %eax
  23:	53                   	push   %ebx
  ...
  33:	68 00 04 10 80       	push   $0x80100400
  38:	e8 96 03 00 00       	call   3d3 <va_to_pa>
  3d:	50                   	push   %eax
  3e:	68 00 04 10 80       	push   $0x80100400
  43:	68 20 08 00 00       	push   $0x820
  48:	6a 01                	push   $0x1
  4a:	e8 71 04 00 00       	call   4c0 <printf>
  printf(1, "Physical Address of Kernel virtual address %p is %p\n", kva2, va_to_pa(kva2));
  4f:	83 c4 14             	add    $0x14,%esp
  52:	68 00 08 10 80       	push   $0x80100800
  57:	e8 77 03 00 00       	call   3d3 <va_to_pa>
  5c:	50                   	push   %eax
  5d:	68 00 08 10 80       	push   $0x80100800
  62:	68 20 08 00 00       	push   $0x820
  67:	6a 01                	push   $0x1
  69:	e8 52 04 00 00       	call   4c0 <printf>
  printf(1, "Physical Address of Kernel virtual address %p is %p\n", kva3, va_to_pa(kva3));
  6e:	83 c4 14             	add    $0x14,%esp
  71:	68 00 10 10 80       	push   $0x80101000
  76:	e8 58 03 00 00       	call   3d3 <va_to_pa>
  7b:	50                   	push   %eax
  7c:	68 00 10 10 80       	push   $0x80101000
  81:	68 20 08 00 00       	push   $0x820
  86:	6a 01                	push   $0x1
  88:	e8 33 04 00 00       	call   4c0 <printf>
  printf(1, "Physical Address of Kernel virtual address %p is %p\n", kva4, va_to_pa(kva4));
  8d:	83 c4 14             	add    $0x14,%esp
  90:	68 48 14 10 80       	push   $0x80101448
  95:	e8 39 03 00 00       	call   3d3 <va_to_pa>
  9a:	50                   	push   %eax
  9b:	68 48 14 10 80       	push   $0x80101448
  a0:	68 20 08 00 00       	push   $0x820
  a5:	6a 01                	push   $0x1
 ...
 41c:	89 d1                	mov    %edx,%ecx
{
 ...
 48e:	56                   	push   %esi
 48f:	57                   	push   %edi
 490:	e8 9e fe ff ff       	call   333 <write>
  while(--i >= 0)
 ...
 4c9:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 505:	57                   	push   %edi
 506:	56                   	push   %esi
 507:	e8 27 fe ff ff       	call   333 <write>
 ...
 55e:	e8 d0 fd ff ff       	call   333 <write>
        putc(fd, c);
 ...
 56f:	57                   	push   %edi
 570:	56                   	push   %esi
 571:	e8 bd fd ff ff       	call   333 <write>
        putc(fd, c);
 ...
 5db:	57                   	push   %edi
 5dc:	56                   	push   %esi
 5dd:	e8 51 fd ff ff       	call   333 <write>
        while(*s != 0){
...
free(void *ap)
{
 ...
 661:	a1 60 0b 00 00       	mov    0xb60,%eax
{
 ...
 6a1:	5b                   	pop    %ebx
  freep = p;
 6a2:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 6a8:	5e                   	pop    %esi
 6a9:	5f                   	pop    %edi
 6aa:	5d                   	pop    %ebp
 ...
 6d9:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 6dc:	89 15 60 0b 00 00    	mov    %edx,0xb60
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6f9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6fc:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 73f:	73 4f                	jae    790 <malloc+0xa0>
    ...
    if(p == freep)
 741:	8b 3d 60 0b 00 00    	mov    0xb60,%edi
 ...
 753:	e8 43 fc ff ff       	call   39b <sbrk>
  if(p == (char*)-1)
 ...
 76a:	e8 f1 fe ff ff       	call   660 <free>
  return freep;
 76f:	8b 15 60 0b 00 00    	mov    0xb60,%edx
 ...
 79c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 79f:	89 15 60 0b 00 00    	mov    %edx,0xb60
}
 ...
 7af:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 7b0:	c7 05 60 0b 00 00 64 	movl   $0xb64,0xb60
 7b7:	0b 00 00 
    base.s.size = 0;
 7ba:	bf 64 0b 00 00       	mov    $0xb64,%edi
    base.s.ptr = freep = prevp = &base;
 7bf:	c7 05 64 0b 00 00 64 	movl   $0xb64,0xb64
 7c6:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 7c9:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 7cb:	c7 05 68 0b 00 00 00 	movl   $0x0,0xb68
 7d2:	00 00 00 
    if(p->s.size >= nunits){
