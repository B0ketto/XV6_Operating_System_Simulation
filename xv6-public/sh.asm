...
fork1(void)
{
  ...
  if(buf[0] == 0) // EOF
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     100:	51                   	push   %ecx
     101:	68 43 1a 00 00       	push   $0x1a43
     106:	68 a1 13 00 00       	push   $0x13a1
     10b:	6a 02                	push   $0x2
...
000001b0 <runcmd>:
{
  ...
  switch(cmd->type){
     ...
     1c9:	ff 24 85 b0 13 00 00 	jmp    *0x13b0(,%eax,4)
    if(ecmd->argv[0] == 0)
     ...
     479:	8b 45 08             	mov    0x8(%ebp),%eax
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     49d:	50                   	push   %eax
     49e:	68 1c 1a 00 00       	push   $0x1a1c
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     4ed:	50                   	push   %eax
     4ee:	68 1c 1a 00 00       	push   $0x1a1c
  ...
  *ps = s;
  ...
  if(eq)
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     52e:	50                   	push   %eax
     52f:	68 14 1a 00 00       	push   $0x1a14
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     550:	56                   	push   %esi
     551:	68 1c 1a 00 00       	push   $0x1a1c
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     5fd:	50                   	push   %eax
     5fe:	68 1c 1a 00 00       	push   $0x1a1c
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     663:	68 49 13 00 00       	push   $0x1349
     668:	53                   	push   %ebx
     669:	56                   	push   %esi
  ...
  return cmd;
     ...
     77e:	68 2c 13 00 00       	push   $0x132c
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     79f:	68 4c 13 00 00       	push   $0x134c
     7a4:	57                   	push   %edi
     7a5:	56                   	push   %esi
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     806:	68 63 13 00 00       	push   $0x1363
     80b:	57                   	push   %edi
     80c:	56                   	push   %esi
    ...
    if(argc >= MAXARGS)
     ...
     850:	68 55 13 00 00       	push   $0x1355
  ...
  cmd->eargv[argc] = 0;
     ...
     899:	68 4e 13 00 00       	push   $0x134e
...
000008b0 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     8c9:	68 68 13 00 00       	push   $0x1368
  cmd = parseexec(ps, es);
...
00000940 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     99b:	68 6a 13 00 00       	push   $0x136a
     9a0:	57                   	push   %edi
     9a1:	56                   	push   %esi
  ...
  if(peek(ps, es, ";")){
     ...
     9b1:	68 66 13 00 00       	push   $0x1366
     9b6:	57                   	push   %edi
     9b7:	56                   	push   %esi
...
00000a20 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     a2f:	68 4c 13 00 00       	push   $0x134c
     a34:	56                   	push   %esi
     a35:	53                   	push   %ebx
  ...
  if(!peek(ps, es, ")"))
     ...
     a59:	68 88 13 00 00       	push   $0x1388
  cmd = parseline(ps, es);
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     ac9:	ff 24 85 c8 13 00 00 	jmp    *0x13c8(,%eax,4)
...
00000ec3 <worldpeace>:
SYSCALL(worldpeace)
     ec3:	b8 17 00 00 00       	mov    $0x17,%eax
     ec8:	cd 40                	int    $0x40
     eca:	c3                   	ret    

00000ecb <numberofprocesses>:
...
00000ee3 <va_to_pa>:
SYSCALL(va_to_pa)
     ee3:	b8 1d 00 00 00       	mov    $0x1d,%eax
     ee8:	cd 40                	int    $0x40
     eea:	c3                   	ret    

00000eeb <get_pgtb_size>:
SYSCALL(get_pgtb_size)
     eeb:	b8 1e 00 00 00       	mov    $0x1e,%eax
     ef0:	cd 40                	int    $0x40
     ef2:	c3                   	ret    

00000ef3 <get_usr_pgtb_size>:
SYSCALL(get_usr_pgtb_size)
     ef3:	b8 1f 00 00 00       	mov    $0x1f,%eax
     ef8:	cd 40                	int    $0x40
     efa:	c3                   	ret    

00000efb <get_kernel_pgtb_size>:
SYSCALL(get_kernel_pgtb_size)
     efb:	b8 20 00 00 00       	mov    $0x20,%eax
     f00:	cd 40                	int    $0x40
     f02:	c3                   	ret    

00000f03 <getpasize>:
SYSCALL(getpasize)
     f03:	b8 22 00 00 00       	mov    $0x22,%eax
     f08:	cd 40                	int    $0x40
     f0a:	c3                   	ret    

00000f0b <mmap>:
     f0b:	b8 23 00 00 00       	mov    $0x23,%eax
     f10:	cd 40                	int    $0x40
     f12:	c3                   	ret    
