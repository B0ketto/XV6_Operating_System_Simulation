 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba 9c 07 00 00       	mov    $0x79c,%edx
        while(*s != 0){
 ...
 601:	a1 b4 0a 00 00       	mov    0xab4,%eax
{
 ...
 641:	5b                   	pop    %ebx
  freep = p;
 642:	89 15 b4 0a 00 00    	mov    %edx,0xab4
}
 648:	5e                   	pop    %esi
 649:	5f                   	pop    %edi
 64a:	5d                   	pop    %ebp
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 b4 0a 00 00    	mov    %edx,0xab4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d b4 0a 00 00    	mov    0xab4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d b4 0a 00 00    	mov    0xab4,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 b4 0a 00 00    	mov    0xab4,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 b4 0a 00 00    	mov    %edx,0xab4
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 b4 0a 00 00 b8 	movl   $0xab8,0xab4
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf b8 0a 00 00       	mov    $0xab8,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 b8 0a 00 00 b8 	movl   $0xab8,0xab8
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 bc 0a 00 00 00 	movl   $0x0,0xabc
 772:	00 00 00 
    if(p->s.size >= nunits){
