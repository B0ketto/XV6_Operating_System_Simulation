 ...
 49c:	89 d1                	mov    %edx,%ecx
{
 ...
 4c9:	0f b6 92 ec 08 00 00 	movzbl 0x8ec(%edx),%edx
 ...
 549:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 5b9:	ff 24 85 94 08 00 00 	jmp    *0x894(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 6c7:	90                   	nop
          s = "(null)";
 6c8:	ba 8b 08 00 00       	mov    $0x88b,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6e1:	a1 a4 0b 00 00       	mov    0xba4,%eax
{
 ...
 721:	5b                   	pop    %ebx
  freep = p;
 722:	89 15 a4 0b 00 00    	mov    %edx,0xba4
}
 728:	5e                   	pop    %esi
 729:	5f                   	pop    %edi
 72a:	5d                   	pop    %ebp
 ...
 759:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 75c:	89 15 a4 0b 00 00    	mov    %edx,0xba4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 779:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 77c:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7bf:	73 4f                	jae    810 <malloc+0xa0>
    ...
    if(p == freep)
 7c1:	8b 3d a4 0b 00 00    	mov    0xba4,%edi
 ...
 7ea:	e8 f1 fe ff ff       	call   6e0 <free>
  return freep;
 7ef:	8b 15 a4 0b 00 00    	mov    0xba4,%edx
 ...
 81c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 81f:	89 15 a4 0b 00 00    	mov    %edx,0xba4
}
 ...
 82f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 830:	c7 05 a4 0b 00 00 a8 	movl   $0xba8,0xba4
 837:	0b 00 00 
    base.s.size = 0;
 83a:	bf a8 0b 00 00       	mov    $0xba8,%edi
    base.s.ptr = freep = prevp = &base;
 83f:	c7 05 a8 0b 00 00 a8 	movl   $0xba8,0xba8
 846:	0b 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 849:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 84b:	c7 05 ac 0b 00 00 00 	movl   $0x0,0xbac
 852:	00 00 00 
    if(p->s.size >= nunits){
