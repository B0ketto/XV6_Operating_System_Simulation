...
0000049b <get_pgtb_size>:
SYSCALL(get_pgtb_size)
 49b:	b8 1e 00 00 00       	mov    $0x1e,%eax
 4a0:	cd 40                	int    $0x40
 4a2:	c3                   	ret    

000004a3 <get_usr_pgtb_size>:
SYSCALL(get_usr_pgtb_size)
 4a3:	b8 1f 00 00 00       	mov    $0x1f,%eax
 4a8:	cd 40                	int    $0x40
 4aa:	c3                   	ret    

000004ab <get_kernel_pgtb_size>:
SYSCALL(get_kernel_pgtb_size)
 4ab:	b8 20 00 00 00       	mov    $0x20,%eax
 4b0:	cd 40                	int    $0x40
 4b2:	c3                   	ret    
