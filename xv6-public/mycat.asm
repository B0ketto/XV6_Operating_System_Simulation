...
int main(){
   ...
   d:	53                   	push   %ebx
   e:	51                   	push   %ecx
   f:	8d 9d f8 fb ff ff    	lea    -0x408(%ebp),%ebx
  15:	81 ec 00 04 00 00    	sub    $0x400,%esp
  1b:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  1f:	90                   	nop
	while(1){
		char buff[1024];
		printf(1, ">>>");
  ...
  28:	6a 01                	push   $0x1
  2a:	e8 31 04 00 00       	call   460 <printf>
		read(0, buff, 1024);
  2f:	83 c4 0c             	add    $0xc,%esp
  32:	68 00 04 00 00       	push   $0x400
  37:	53                   	push   %ebx
  38:	6a 00                	push   $0x0
  3a:	e8 8c 02 00 00       	call   2cb <read>
		write(1, buff, 1024);
  3f:	83 c4 0c             	add    $0xc,%esp
  42:	68 00 04 00 00       	push   $0x400
  47:	53                   	push   %ebx
  48:	6a 01                	push   $0x1
  4a:	e8 84 02 00 00       	call   2d3 <write>
	while(1){
  4f:	83 c4 10             	add    $0x10,%esp
  52:	eb cc                	jmp    20 <main+0x20>
  54:	66 90                	xchg   %ax,%ax
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
 ...
 469:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 4d9:	ff 24 85 94 07 00 00 	jmp    *0x794(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 5e7:	90                   	nop
          s = "(null)";
 5e8:	ba 8c 07 00 00       	mov    $0x78c,%edx
        while(*s != 0){
 ...
 601:	a1 98 0a 00 00       	mov    0xa98,%eax
{
 ...
 679:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 67c:	89 15 98 0a 00 00    	mov    %edx,0xa98
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 4f                	jae    730 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	8b 3d 98 0a 00 00    	mov    0xa98,%edi
 ...
 70a:	e8 f1 fe ff ff       	call   600 <free>
  return freep;
 70f:	8b 15 98 0a 00 00    	mov    0xa98,%edx
 ...
 73c:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 73f:	89 15 98 0a 00 00    	mov    %edx,0xa98
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 98 0a 00 00 9c 	movl   $0xa9c,0xa98
 757:	0a 00 00 
    base.s.size = 0;
 75a:	bf 9c 0a 00 00       	mov    $0xa9c,%edi
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 9c 0a 00 00 9c 	movl   $0xa9c,0xa9c
 766:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 769:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 76b:	c7 05 a0 0a 00 00 00 	movl   $0x0,0xaa0
 772:	00 00 00 
    if(p->s.size >= nunits){
